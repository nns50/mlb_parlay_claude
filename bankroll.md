...
| 11 | 8/3 | 1 | $10.00 | — NO BET — | — | — | $10.00 (carries) | Second straight NO BET from the same cause: PULSE's MARKET-SHADE on `type:ML-fav` (recent CLV 6+/12−) forces every favorite's TrueP to the market no-vig, so all eight favorites on an 8-game board sit at exactly 0.0pp edge. PHI (−153), MIL (−137) and HOU (−124) are additionally D4 own-SP-ERA traps (Nola 5.61, Sproat 5.05, Javier 7.17). No qualifying favorite → NO BET, balance carries. |
