...
|------|---------|------|-------|-------|--------|----------------------------|
| 8/24 | PHI @ SEA (Wheeler/Gilbert) | NRFI | 63% | _model-only_ | TBD | Board's strongest lean — Wheeler 1.01 / Gilbert 1.01, two best WHIPs, T-Mobile most suppressing park. |
| 8/24 | MIN @ ATH (Z.Matthews/Springs) | YRFI | 60% | _model-only_ | TBD | Two of the worst arms (5.12/6.02) at hot small Sutter Health Park. |
| 8/24 | CHC @ AZ (Gausman/M.Kelly) | YRFI | 59% | _model-only_ | TBD | Two mediocre arms + loaded CHC top; Kelly 5.37/1.52 last start 6 ER. |
| 8/24 | TEX @ CWS (Rocker/Urquidy) | YRFI | 58% | _model-only_ | TBD | Urquidy 16-IP fresh sample, Rocker 1.40 WHIP; Rate Field hitter park. |
| 8/24 | COL @ WSH (Feltner/Cavalli) | YRFI | 57% | _model-only_ | TBD | Feltner 5.97/1.53 worst real-SP line; Cavalli 3.22 caps it at 57%. |
| 8/24 | CLE @ LAA (Messick/Klassen) | YRFI | 56% | _model-only_ | TBD | Messick elite but Klassen (rookie) 1.62 WHIP leaks early — one-sided. |
| 8/24 | TB @ DET (Rasmussen/Valdez) | NRFI | 57% | _model-only_ | TBD | Rasmussen 0.95 best WHIP, Valdez GB arm; spacious Comerica. |
| 8/24 | PIT @ SD (Ashcraft/R.Ray) | NRFI | 57% | _model-only_ | TBD | Petco 2nd-most suppressing; PIT top weak; both arms solid. |
| 8/24 | BOS @ MIA (Suarez/Alcantara) | NRFI | 56% | _model-only_ | TBD | Two steady arms (3.41/3.46), loanDepot dome; BOS top counterweight. |
| 8/24 | CIN @ SF (Burns/TBD) | NRFI | 55% | _model-only_ | TBD | E4 — SF probable TBD; rests on Burns 2.51/1.11 + Oracle. LOW CONF. |
