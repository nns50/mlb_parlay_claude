...
| 8/16 | BOS @ PIT (Sandoval/Bachar-BULLPEN) | YRFI | 58% | _model-only_ | TBD | Sandoval 1.70 WHIP puts men on early; PNC 10mph out to CF. E5 on the PIT side. |
...
| 8/16 | SD @ CLE (Mize/Bibee) | NRFI | 51% | _model-only_ | TBD | Two competent arms in a pitcher park; 9mph out to RF caps the lean. ⚠ **16:00: BOTH lineups CONFIRMED, but the game is RAIN-DELAYED** (first pitch pushed 13:40 → 16:51 ET). Read held at 51% — a delay adds start-length noise on both arms, which cuts toward NRFI marginally but not enough to move a 51% model-only lean. ⚠ Mize's 3.38 is a blend hiding **9.64/2.04 over 9.1 IP post-trade**. |
...
| 8/16 | COL @ SF (Hughes/Tidwell) | YRFI | 54% | _model-only_ | TBD | Hughes 5.61 leans Over alone; Oracle Park is why this is 54 not 60. |
| 8/16 | TEX @ ATH (Bradford/Lopez) | YRFI | 58% | _model-only_ | TBD | Lopez 1.56 WHIP in a small hot park; ⚠ Bradford's 11.1 IP sample is not load-bearing. |
