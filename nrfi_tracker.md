...
| 8/20 | ATH @ KC (Jump/Dobnak) | YRFI | 55% | _model-only_ | TBD | Jump 4.50 / 1.45 with 6/2 recent variance (3.2/6, 6/2, 5.1/3) is the soft half. Dobnak 1.73 season on 6-GS small sample; 1.30 WHIP concedes traffic and K/9 5.40 is 2nd-lowest on the board. Kauffman neutral, wind 5 mph IN From CF at 79°F a mild counter. |
| 8/20 | ATL @ CWS (Holmes/Kay) | NRFI | 55% | _model-only_ | TBD | Two average-ish arms with steady recent form: Holmes 3.82 / 1.35 (last three 3.45), Kay 4.01 / 1.34 (last three 2.55). Rate Field neutral, wind 8 mph L To R a wash. |
| 8/20 | SEA @ MIL (Kirby/Gasser) | NRFI | 58% | _model-only_ | TBD | Kirby 3.89 / 1.31 with 7.51 K/9, last three at 3.24. Gasser 4.54 / 1.24 with 8.35 K/9 last three at 3.94. Dome, no weather input. ⚠ MIL scored 22 runs in this park two days ago — noted, not weighted. |
