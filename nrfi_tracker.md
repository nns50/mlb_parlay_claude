...
| 8/22 | STL @ PHI (TBD/Painter) | YRFI | 58% | _model-only_ | TBD | ⚠ **E4 — St. Louis have not named a probable**, so half the read is unresolved and the number is held short of conviction. **Painter 6.43 / 1.55** is the worst WHIP of any named starter today. |
...
| 8/22 | CLE @ COL (Bibee/G.Hughes) | YRFI | **65%** | _model-only_ | TBD | ⭐ Board's strongest YRFI: Coors, the slate's highest total by 2.5 runs, and **Gabriel Hughes' L3 = 13.1 IP / 19 ER = 12.83**. Same construction that cashed here yesterday. Bibee (4.01/1.15) is the better half at a 5.50 L3. |
