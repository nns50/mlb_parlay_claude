...
|---|---|---|---|---|
| **STL @ CIN (G1)** | Mathews 3.60/1.80 (**1 GS**) · **Emanuel = BULLPEN GAME (0 career GS)** | **YRFI** | 62% | ⭐ Board's second-strongest: two arms with no starting workload between them at the NL's best hitter's park, 81°F with 5 mph out to LF. ⛔ E5 — no ML/total leg built here. |
