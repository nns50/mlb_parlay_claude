...
| 8/11 | PIT @ MIA (Skenes 1.12 / E. Pérez 1.13) | NRFI | 63% | **−155 (BetMGM) → no-vig 59.3%, Edge +3.7pp** | **TBD** | ⭐ **PROMOTED TO A BET at 16:00** — the first read in this tracker to clear the +2pp bar. Strongest read of the night: two front-line arms (11.24 / 9.93 K9) at a **roof-closed** loanDepot (wind 0); neither top-of-order dangerous. The 63% was pre-registered here at 11:00 **before any 1st-inning line was pulled**. ⚠ Five books posted, spread **−155 (BetMGM) to −189 (BetOnline)** — a 34-point gap, so the shop is worth more than the model. ¼-Kelly 1.41u. |
| 8/11 | MIL @ SD (Harrison **1.04** / Buehler 1.46) | NRFI | 59% | _model-only_ | **TBD** | Petco; Harrison's 1.04 / 11.27 K9 is the best 1st-inning profile on the board. Held under 62% by Buehler's 1.46. |
| 8/11 | BOS @ TOR (Sandoval 1.67 / **Cease 1.04**) | NRFI | 57% | _model-only_ | **TBD** | Cease (2.28, 13.11 K9) is the slate's best arm; discounted for Sandoval's 1.67 WHIP over 24.0 IP. |
| 8/11 | CIN @ CWS (Lodolo 1.47 / Burke 1.12) | NRFI | 54% | _model-only_ | **TBD** | Burke 3.08 / 10.07 K9 carries it; Lodolo's 1.47 is the drag. |
| 8/11 | PHI @ STL (Sánchez 1.22 / Pallante 1.22) | NRFI | 54% | _model-only_ | **TBD** | Identical WHIPs, both sub-3.65 ERA. Sánchez the better arm; Pallante's 6.53 K9 means contact-dependent outs. |
| 8/11 | CLE @ DET (Bibee 1.13 / **bullpen game**) | NRFI | 53% | _model-only_ | **TBD** | ⚠ **FLIPPED #1, and the 16:00 gamelog CONFIRMS why.** Raw YRFI 58% (Anderson has 3 GS in 67.1 IP; DET +87 RDiff) → corrected to NRFI 53%. **E5 check at 16:00: Anderson's last twelve appearances are all relief (1.0–3.2 IP) — Detroit is running an opener/bullpen game**, so the 11:00 suspicion off the odd GS/IP ratio was right. Read HELD at 53% rather than moved: an opener's 1st inning is the least predictable on the board and cuts both ways. Row-level grading. |
| 8/11 | SEA @ NYY (Woo 1.12 / Weathers 1.22) | NRFI | 52% | _model-only_ | **TBD** | Two tidy WHIPs held to a coin flip by the Yankee 1-2-3. |
| 8/11 | BAL @ MIN (Young 1.31 / Ober 1.22) | NRFI | 52% | _model-only_ | **TBD** | ⚠ **FLIPPED #2.** Raw YRFI 57% (Ober 4.45 / 6.10 K9, lowest-K arm on the slate; this pairing went 14 runs yesterday) → corrected to NRFI 52%. The row I most expect the correction to miss. |
| 8/11 | NYM @ ATL (McLean 1.16 / M. Pérez 1.15) | NRFI | 51% | _model-only_ | **TBD** | Both fine; barely above the line because ATL's top-of-order put 5 on the board in the 1st yesterday. |
| 8/11 | CHC @ WSH (Imanaga 1.09 / **Irvin 1.29**) | NRFI | 53% | _model-only_ | **TBD** | ✅ **E4 LIFTED at 16:00** — WSH probable posted: **Jake Irvin, 5.37 ERA / 1.29 WHIP, 13 GS / 62.0 IP**. 51% (flattened) → **53%**: Imanaga's 1.09 is the best half, Irvin's 1.29 is mediocre rather than bad. ⚠ **C3** — Irvin has no start between 5/23 and 7/30; last two went 5.0 and 5.1 IP, so his 1st-inning sample is thin. Nationals Park is untagged, so no bettable side either way. |
| 8/11 | COL @ AZ (Sugano 1.26 / Bratt 1.52) | YRFI | 52% | _model-only_ | **TBD** | Raw YRFI 57% → 52%. Bratt 6 GS / 27.2 IP; Sugano 5.10 K9. Roof-shut Chase is the only suppressant. |
| 8/11 | HOU @ SF (H. Brown 1.24 / **Whisenhunt 1.84**) | YRFI | 56% | _model-only_ | **TBD** | ✅ **E4 LIFTED at 16:00** — SF probable posted: **Carson Whisenhunt, 7.25 ERA / 1.84 WHIP, 5 GS / 22.1 IP = 4.5 IP/start**. 52% (flattened) → **56%**: a 1.84 WHIP is the worst on the slate and the YRFI read strengthens accordingly. ⚠ Oracle Park and Hunter Brown (3.53 / 1.24) are the suppressants holding it under 60%. |
| 8/11 | TEX @ LAA (Bradford 1.62 / **R. Johnson 1.60**) | YRFI | 56% | _model-only_ | **TBD** | Raw YRFI 61% → 56%. Worst WHIP pair on the slate; Johnson 7.11 ERA over 10 GS, Bradford has 4.1 IP all season. |
| 8/11 | KC @ LAD (Wacha 1.15 / **Snell — 3.0 IP all season**) | YRFI | 57% | _model-only_ | **TBD** | Raw YRFI 62% → 57%. ⚠ Snell's WHIP is 3 innings of noise and is NOT used; the read is his rust/pitch cap plus the LAD 1-2-3. |
| 8/11 | TB @ ATH (Martinez **1.10** / Barnett 1.38) | YRFI | 58% | _model-only_ | **TBD** | Raw YRFI 63% → 58%, strongest YRFI of the night. Most hitter-friendly park in MLB; Barnett is a swingman (2 GS / 34.0 IP) starting. ⚠ Martinez at 2.65 / 1.10 is a real arm — only one half is soft. |
...
- **Record:** **177-151** (tracker opened 6/10/26). **NRFI:** **87-78** · **YRFI:** **90-73**. _(**8/9 is now FULLY SETTLED — 15 of 15 reads decided, and the day finished 10W-10L (50%)**; the five rows still open at the 18:30 Build C lock were auto-stamped off `linescore.innings[0]` at session start — DET@SF **W**, TB@SEA **L**, LAD@AZ **L**, CLE@CWS **L**, HOU@SD **L**. 8/8's 11-3 remains the tracker's best slate.)_
- **Staked:** $0 · **P/L:** $0.00 (model leans only — no priced bets yet; tracking calibration).
- **Open:** **8/11 — 15 reads logged, all model-only, all TBD** (10 NRFI / 5 YRFI after the correction; raw split is 8/7, so the ratchet reversed two reads — **CLE @ DET** and **BAL @ MIN**, both marked for row-level grading). ~~Two rows (**CHC @ WSH**, **HOU @ SF**) are **E4-gated** on TBD probables and are written flat rather than guessed.~~ **RESOLVED at the 16:00 run** — both probables posted: CHC@WSH → **Jake Irvin 5.37 / 1.29** (flat 51% → **NRFI 53%**, C3-flagged on a 5/23→7/30 layoff), HOU@SF → **Carson Whisenhunt 7.25 / 1.84** (flat 52% → **YRFI 56%**, the worst WHIP on the slate). The NRFI/YRFI split is unchanged at 10/5. **CLE @ DET's flip is now confirmed rather than suspected** — the 16:00 E5 gamelog check shows Anderson's last twelve appearances are all relief, so Detroit is an opener/bullpen game; the read HELD at 53% because an opener's first inning cuts both ways. ⭐ **PIT @ MIA promoted to a real bet** at −155 BetMGM (no-vig 59.3%, **+3.7pp**) — the first row in this tracker to clear the bar. ⚠ **KC @ LAD is written without using Snell's WHIP at all** — 3.0 IP in one start is noise, and the read rests on his rust/pitch cap plus the Dodger top-of-order.
