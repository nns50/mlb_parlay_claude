...
| 8/12 | BOS @ TOR (Suarez 1.17 / Soriano 1.26) | NRFI | 56% | _model-only_ | TBD | Two competent arms (3.32 / 3.24 ERA, 9.44 / 9.16 K9), closed roof, neither top-of-order a standing engine. |
| 8/12 | MIL @ SD (May 1.27 / Ray 1.33) | NRFI | 55% | _model-only_ | TBD | Petco. Ray (3.24) the better half; May 4.30 / 1.27 the drag. MIL's +131 top-of-order is the live YRFI half. |
| 8/12 | CLE @ DET (**Griffin 1.11** / Valdez 1.37) | NRFI | 55% | _model-only_ | TBD | Griffin 1.11 over 23 GS / 133.1 IP is real; Valdez 4.17 / 1.37 with 7.28 K9 gets outs on the ground. DET +89 is the counter. |
| 8/12 | PIT @ MIA (Mlodzinski 1.36 / Junk 1.36) | NRFI | 53% | _model-only_ | TBD | Identical mediocre WHIPs but neither top-of-order dangerous (PIT +19, MIA +17); roof closed. Contact-dependent outs keep it near the line. |
| 8/12 | SEA @ NYY (**Miller 0.95** / Warren 1.37) | NRFI | 53% | _model-only_ | TBD | Miller's 0.95 over 13 GS is the 2nd-best profile today; held to a coin flip by the Yankee 1-2-3 (+85) facing Warren's 1.37. |
...
| 8/12 | NYM @ ATL (Thornton 1.07 / Mahle 1.36) | NRFI | 51% | _model-only_ | TBD | ⚠ **FLIPPED READ.** Raw YRFI 56% (ATL top-of-order best on the board at +121; Mahle 4.83 / 1.36; Thornton is a short-role arm at 7 GS / 39.1 IP) → corrected to NRFI 51%. Row-level grading; the row I most expect the correction to miss. |
...
| 8/12 | CHC @ WSH (Peterson **1.50** / **Kent — no 2026 record**) | YRFI | 51% | _model-only_ | TBD | ⚠ Half the read is missing — Jackson Kent returns no 2026 StatsAPI pitching line, so the number is flattened rather than guessed. Peterson's 5.35 / 1.50 is the worst qualified WHIP on the board; CHC +109 is the live half. Re-read at 16:00. |
| 8/12 | KC @ LAD (**Lynch — 1 GS / 47.2 IP** / Lauer 1.26) | YRFI | 52% | _model-only_ | TBD | Raw YRFI 57% → 52%. ⚠ Lynch's 1.01 WHIP is relief data and is NOT used — he is a swingman (E5-adjacent). Read rests on the LAD 1-2-3 (+140) vs Lauer's 4.89 ERA / 5.58 K9 contact profile. |
| 8/12 | CIN @ CWS (Lowder **1.48** / Castillo **1.41**) | YRFI | 54% | _model-only_ | TBD | Raw YRFI 59% → 54%. Both starters over 5.20 ERA and 1.40 WHIP — the only game where neither half suppresses. Rate Field carry is a 1st-inning HR risk. ⚠ Neither top-of-order is an engine. |
| 8/12 | COL @ AZ (Feltner **1.45** / Kelly **1.47**) | YRFI | 55% | _model-only_ | TBD | Raw YRFI 60% → 55%. Worst ERA pair on the board (5.71 / 4.88), two 1.45+ WHIPs, two low K rates (6.48 / 6.00). Roof-shut Chase is the only suppressant. |
| 8/12 | TEX @ LAA (Quantrill 1.19 / **Klassen 2.88 — 8.2 IP**) | YRFI | 58% | _model-only_ | TBD | Raw YRFI 63% → 58%, **strongest YRFI of the day.** Klassen's 2.88 WHIP over 8.2 IP / 3 GS is ~3 baserunners per inning, the most extreme number on the board either way. ⚠ 8.2 IP is a tiny sample (E2 with the sign flipped) and Quantrill's 3.56 / 1.19 half is genuinely competent. |
...
- **Record:** **191-156** (tracker opened 6/10/26). **NRFI:** **96-81** · **YRFI:** **95-75**. _(**8/9 is now FULLY SETTLED — 15 of 15 reads decided, and the day finished 10W-10L (50%)**; the five rows still open at the 18:30 Build C lock were auto-stamped off `linescore.innings[0]` at session start — DET@SF **W**, TB@SEA **L**, LAD@AZ **L**, CLE@CWS **L**, HOU@SD **L**. 8/8's 11-3 remains the tracker's best slate.)_
- **Staked:** $0 · **P/L:** $0.00 (model leans only — no priced bets yet; tracking calibration).
- **Open:** **8/12 — 15 reads logged, all model-only; four games are settled and ALL FOUR WON (4-0, 100%).** ✅ **PHI @ STL NRFI 58%** (1st 0-0) — the day's strongest read either way, off Wheeler's 0.98 WHIP, and it held even though Philadelphia went on to concede 7 later in the game. ✅ **BAL @ MIN YRFI 52%** (1st 1-1) — Matthews at 5.23 was the softest qualified starter of the early window and both tops scored immediately; the 82°F / 5 mph in-from-centre counter did not bite. ✅ **TB @ ATH NRFI 53%** (1st 0-0) — Rasmussen's board-best 0.91 WHIP held in the majors' most hitter-friendly park, the read the note had called *"barely above the line by design, not confidence."* ✅ **HOU @ SF YRFI 51%** (1st 0-1) — **the most interesting settle of the day**, because this is the row that was deliberately FLATTENED rather than pushed: Houston ran a bullpen game (Bryan King, 0 GS / 49.1 IP), and doctrine says an opener's first inning is the least predictable on any board and cuts both ways. Flattening it to 51% and still taking the side is the correct expression of that uncertainty, and it cashed. **Day 4-0; record now 191-156** (NRFI 96-81 · YRFI 95-75). **11 reads still open**, all in games unfinished at the 18:20 ET final lock — they settle at tomorrow's 11:00 run. ⚠ **Two data traps still standing in the open rows:** **CHC @ WSH's Jackson Kent returns no 2026 StatsAPI pitching line at all** (re-queried three times today, still empty), so half that read is missing; and **KC @ LAD's Daniel Lynch IV shows a 1.01 WHIP that is relief data** (1 GS in 47.2 IP, twelve straight outings of ≤2.0 IP) — tonight's build voided every market in that game on **E5**, and the NRFI read is correspondingly low-confidence. Strongest open read remains **TEX @ LAA YRFI 58%** off George Klassen's **2.88 WHIP over 8.2 IP** — though note the same E5 gate voided that game's full-game total, since Klassen has only 3 GS at a 2-4 IP leash. ⚠ **Tool note, unchanged: `nrfi_settle.py` only stamps a row once the GAME is Final**, even though the first inning decides these reads within ~20 minutes of first pitch — so the final run of the day still leaves eleven rows open that are, in fact, already decided. Recorded as a limitation, not fixed this run.
