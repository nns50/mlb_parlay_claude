...
| 8/19 | AZ @ BOS (Pfaadt/Tolle) | NRFI | 57% | _model-only_ | TBD | The two cleanest WHIPs in one game — **Tolle 1.06 (and 8.0 IP / 0 ER on 8/13), Pfaadt 1.13**. Fenway is the counter-signal and it is a real one; weather is PENDING at 11:00 so the park read is geometry only. |
| 8/19 | MIA @ PHI (Alcantara/Nola) | YRFI | 55% | _model-only_ | TBD | Citizens Bank plus Philadelphia's top three against **Alcantara's 6.86 K/9** — he limits damage but does not miss bats. ⚠ Nola's 1.45 season WHIP overstates his current form (**last three: 16 IP / 6 ER, 22 K**), which is why this is 55% and not 59%. |
| 8/19 | NYY @ BAL (Warren/Bassitt) | YRFI | 60% | _model-only_ | TBD | Two of the worst WHIPs on the board in a hitter park — **Bassitt 1.62 and freshly back from a two-month absence** (one outing since 6/3), **Warren 1.41 with 8 ER in his last 16 IP** — against the Yankees' top three. Camden does the rest. |
| 8/19 | SF @ CLE (Wilkinson/Messick) | NRFI | 55% | _model-only_ | TBD | ⚠ **LOW CONFIDENCE — half this read is unpriceable.** Matt Wilkinson has **zero 2026 MLB innings**; a debut arm's first inning is the widest distribution on the board. The other half is strong: **Messick 1.03 WHIP, 2.13 ERA over his last five**, against the league's weakest offence (51-74, −74). |
| 8/19 | STL @ CIN (Liberatore/Burns) | YRFI | 57% | _model-only_ | TBD | GABP plus **Liberatore's 1.48** as the soft half, against a St. Louis club that is 7-3 in its last ten. **Burns (1.09) is the clean half** and is the reason this is not 60%+. |
| 8/19 | TOR @ TB (Scherzer/Rasmussen) | NRFI | 58% | _model-only_ | TBD | ⭐ **Rasmussen's 0.91 WHIP is the best on the board** and his last four starts allowed 2, 0, 0 and 2 ER. ⚠ Scherzer's 1.46 season WHIP is stale-high — **his last three are 16.1 IP / 4 ER (2.20)** — which strengthens this read rather than weakening it. Dome, no weather input. |
