...
| 8/11 | PIT @ MIA (Skenes 1.12 / E. Pérez 1.13) | NRFI | 63% | _model-only_ | **TBD** | Strongest read of the night. Two front-line arms (11.24 / 9.93 K9) at loanDepot; neither top-of-order dangerous. |
...
| 8/11 | CLE @ DET (Bibee 1.13 / Anderson 1.29) | NRFI | 53% | _model-only_ | **TBD** | ⚠ **FLIPPED #1.** Raw YRFI 58% (Anderson has 3 GS in 67.1 IP; DET +87 RDiff) → corrected to NRFI 53%. Row-level grading. |
...
| 8/11 | CHC @ WSH (Imanaga 1.09 / **TBD**) | NRFI | 51% | _model-only_ | **TBD** | ⚠ **E4-GATED** — WSH probable unannounced; number deliberately flattened rather than guessed. Re-read at 16:00. |
...
| 8/11 | HOU @ SF (H. Brown 1.24 / **TBD**) | YRFI | 52% | _model-only_ | **TBD** | ⚠ **E4-GATED** and SF ran a bullpen game in this series yesterday — an opener's 1st is the least predictable inning on the board. |
