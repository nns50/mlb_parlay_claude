...
| 8/6 | SD @ AZ (Buehler/Drake) | YRFI | 61% | _model-only_ — **16:00 market no-vig 52.4%** (BetMGM O-125/U-102) → **model +8.6pp above market; NO BET** | TBD | Two worst WHIPs on the slate in one game (1.45/1.46) at Chase; Drake 3 GS, Buehler being hit early. |
| 8/6 | CWS @ BOS (Castillo/Suarez) | YRFI | 58% | _model-only_ — **16:00 market no-vig 50.5%** (BetMGM O-115/U-110) → **model +7.5pp above market; NO BET** | TBD | Castillo 5.06/1.39 opens vs a BOS top on a 7-game win streak at Fenway; Suarez caps the other half. |
| 8/6 | MIA @ ATL (Junk/M.Perez) | YRFI | 57% | _model-only_ — **16:00 market no-vig 51.6%** (BetMGM O-120/U-105) → **model +5.4pp above market; NO BET** | TBD | Junk 1.33 WHIP vs the hottest top in baseball (ATL W7, +113) at Truist. |
| 8/6 | WSH @ PHI (Mikolas/C.Sanchez) | YRFI | 56% | _model-only_ — **16:00 market no-vig 50.0%** (FanDuel O-113/U-113) → **model +6.0pp above market; NO BET** | TBD | Mikolas 5.67/4.58 K9 contact-manager in a hitter park; Sánchez (best arm on the slate) makes it one-sided. |
...
| 8/6 | MIN @ KC (Ober/Wacha) | NRFI | 56% | _model-only_ — **16:00 market no-vig 50.0%** (FanDuel O-113/U-113); TrueP 56% lands in the **⛔ COOLed + SHADED 55-59 band** → reset to market, **NO BET** | TBD | Two sub-1.25 WHIPs at Kauffman vs two of the weakest tops on the board. |
...
- **Record:** **145-123** (tracker opened 6/10/26). **NRFI:** **70-60** · **YRFI:** **75-63**.
- **Staked:** $0 · **P/L:** $0.00 (model leans only — no priced bets yet; tracking calibration).
- **Open:** **8/5 FULLY SETTLED — 15 of 15 reads decided; the day finished 7W-8L.** The 13 model-only rows auto-stamped via `nrfi_settle.py --apply`; the **two bet-grade priced reads were settled by hand this run** (the settler does not match the bolded-TrueP row format — a small tooling gap worth closing). Those two went **1-1**: **PIT@MIL NRFI U0.5 −145 (+4.0pp) ✅ WON** on a 0-0 first, and **MIN@KC YRFI O0.5 −110 (+4.0pp) ❌ LOST** on a 0-0 first. ⚠ **The day's real signal is directional and unflattering to the model: 9 of the 15 first innings were scoreless.** Every YRFI lean but one missed (TOR@HOU, SF@TEX, SD@AZ, STL@NYY all 0-0), while the NRFI leans went 6-1. Combined with 8/5's 16:00 note — that three of five priced reads shaded themselves out because *our YRFI lean kept running 8-10pp above the market* — this is now the second independent piece of evidence that **the model's first-inning YRFI bias is real and should be corrected downward**. Held as directional (the tracker's own N-bar applies), but it is the standing hypothesis to test on the next priced sweep. **8/6: 11 reads logged below, all model-only at 11:00 — the priced `totals_1st_1_innings` sweep is the 16:00 run's job (lineups are not posted yet).** **✔ 16:00 SWEEP DONE — and it is the THIRD independent confirmation of the YRFI bias, this time four-for-four with no exceptions:** every open YRFI lean priced **5.4-8.6pp ABOVE** the market (SD@AZ 61% vs 52.4%, CWS@BOS 58% vs 50.5%, WSH@PHI 56% vs 50.0%, MIA@ATL 57% vs 51.6%), and the lone NRFI lean (MIN@KC 56% vs 50.0%) was band-blocked. **No read clears +2pp; all five stay model-only.** CLAUDE.md's `market_disagrees -4pp` rule is squarely in scope, and this tracker's own empirical estimate of the offset is larger (~8-10pp) — which would zero all four. ⚠ **The 11:00 TrueP numbers are deliberately NOT rewritten; they are pre-registered calibration records and back-editing them to the market would destroy the very measurement producing this finding.** The market column is recorded alongside them instead. **RECOMMENDATION, now carrying three sightings: apply a standing -5pp YRFI correction at derivation time starting with tomorrow's 11:00 build, and let the ledger grade it.** Today's settled firsts: LAA@BAL ❌ (0-0), ATH@CIN ✅ (0-1), **NYM@CLE ❌ (0-2 — our cleanest read of either kind, a 60% NRFI, lost)**. **✔ 18:00 UPDATE — 8/6 now 6 of 11 decided, running 3W-3L.** TOR@CHC ✅ (1-0) and PIT@MIL ✅ (0-1) auto-settled at session start; **DET@SEA ❌ hand-settled this run (DET scored 3 in the top of the 1st off Bryce Miller)** — the settler only stamps `Final` games and DET@SEA was In Progress, so it was read off `linescore.innings[0]` directly. ⚠ **Note the shape of today's misses: both losing NRFI leans (NYM@CLE 60%, DET@SEA 57%) were the two built on the best WHIP numbers on the board, while three of five YRFI leans have cashed.** That runs directly *against* the standing YRFI-bias hypothesis carried from 8/5 — one day is noise either way, but the −5pp YRFI correction recommended for tomorrow's 11:00 build should be applied as a *graded experiment*, not as settled doctrine. **Still open (settle on the 8/7 morning run): WSH@PHI** (top 1st was 0, bottom 1st not yet complete at 18:20), **CWS@BOS, MIA@ATL, MIN@KC, SD@AZ.**
