...
## Tonight's reads — 2026-06-12 (model leans, un-priced; pull `totals_1st_1_innings` at the book)
...
|---|---------|----------|------|-------|------------------------|
| 1 | MIA @ PIT | Alcantara vs Ashcraft | **NRFI** | ~54% | Alcantara a GB/sinker arm — weak early contact; both 1-2-3s league-avg. Mild NRFI. |
| 2 | SEA @ WSH | B. Miller vs Littell | **NRFI** | ~58% | Cleanest of the board — Miller (1.33, dominant early, 9K last out) + Littell (low-BB strike-thrower), neither top loaded. |
| 3 | SD @ BAL | Canning vs Baz | **NRFI** | ~55% | Baz K-stuff, Canning competent; SD top slumping (L10 3-7). Mild NRFI. |
| 4 | DET @ CLE | Flaherty vs Bibee | **NRFI** | ~54% | Two mid-rotation arms, league-avg tops; nothing loaded early. |
| 5 | TEX @ BOS | Leiter vs S. Gray | **NRFI** | ~55% | Gray vet K-arm works clean 1sts; TEX top average. Slight NRFI. |
| 6 | AZ @ CIN | E. Rodriguez vs Lodolo | **YRFI** | ~54% | GABP hitter park, two contact-prone LHP; both tops decent → mild YRFI. |
| 7 | ATL @ NYM | Strider vs McLean | **YRFI** | ~54% | ATL's elite top (Acuña/Albies/Olson) vs McLean is the live half; Strider misses bats early but the ATL side carries a slight YRFI. |
| 8 | NYY @ TOR | Weathers vs TBD | **YRFI** | ~55% | NYY top (Judge/Soto) vs a TBD/opener = early-run threat. **TBD SP — model-only, soft.** |
| 9 | LAD @ CWS | Sasaki vs Kay | **YRFI** | ~57% | LAD elite top (Ohtani/Betts/Freeman) vs soft Kay; CWS hot home top vs walk-prone Sasaki — both halves live. |
| 10 | PHI @ MIL | Painter vs Misiorowski | **YRFI** | ~54% | Miso 100mph but wild (walks); PHI top (Schwarber/Harper) strong. Both tops live → mild YRFI. |
| 11 | HOU @ KC | Imai vs Avila | **NRFI** | ~53% | Two uncertain rookies but KC is low-power/contact; lean NRFI by a hair. |
| 12 | STL @ MIN | Leahy vs J. Ryan | **NRFI** | ~57% | Joe Ryan (9.90 K9) quiets STL early; Leahy (swingman) vs MIN's weak top. Clean NRFI side. |
| 13 | TB @ LAA | McClanahan vs Aldegheri | **NRFI** | ~55% | McClanahan (2.85, misses bats) shuts down a weak LAA top early; mild NRFI. |
| 14 | COL @ ATH | TBD vs G. Jump | **YRFI** | ~53% | **COL SP TBD — model-only, soft.** Default slight YRFI (ATH home bats vs a rookie/uncertain COL arm). |
| 15 | CHC @ SF | Assad vs Roupp | **NRFI** | ~55% | Pitcher-friendly Oracle Park, two mid arms, neither top loaded. Slight NRFI. |
...
| 6/12 | COL @ ATH (TBD/Jump) | YRFI | 53% | _model-only (TBD SP)_ | TBD | ATH bats vs uncertain COL arm; soft. |
| 6/12 | CHC @ SF (Assad/Roupp) | NRFI | 55% | _model-only_ | TBD | Pitcher-friendly Oracle, two mid arms. |
