...
| 8/22 | MIN @ SD (Kremer/Mize) | NRFI | 55% | _model-only_ | TBD | Petco plus two arms outperforming their season lines. **Mize 3.18 / 1.07**; **Kremer's L3 17.1 IP / 6 ER = 3.12** against a 5.40 aggregate — E2 stale-HIGH on the Minnesota half. Held to 55 because the aggregate is genuinely bad. |
| 8/22 | TB @ BAL (McClanahan/B.Young) | YRFI | 54% | _model-only_ | TBD | ⚠ **C3 is the whole read** — McClanahan's last two outings are 3.0 and 3.1 IP after an 18-day gap. **Young's L3 14.1 IP / 8 ER = 5.02** is the worse half. Thin lean, logged for calibration. |
| 8/22 | DET @ KC (D.Anderson/Wacha) | YRFI | 54% | _model-only_ | TBD | ⚠ **E5 — Drew Anderson is a reliever mid-stretch-out** (5 GS across 76.1 IP; 3.2, 4.0, 5.0 IP most recently). A converted arm's 1st inning is his least-tested. **Wacha 3.58 / 1.15** holds the number down. Thinnest lean on the board. |
| 8/22 | ATH @ HOU (J.Lopez/H.Brown) | YRFI | 55% | _model-only_ | TBD | Houston's half is the read and it inverts the full-game market: **Hunter Brown's L3 is 16.0 IP / 8 ER = 4.50 with five walks in his most recent start** — walks are the most reliable 1st-inning YRFI driver. Lopez's 5.22/1.53 supports; his 3.00 L3 argues against. |
| 8/22 | PIT @ LAD (J.Jones/Skubal) | YRFI | 55% | _model-only_ | TBD | Jared Jones owns it: 4.78 / 1.20 understates an **L3 of 12.0 IP / 12 ER = 9.00** (incl. 3.0 IP / 8 ER on 8/9). **Skubal 2.85 / 0.96 is the best NRFI half on the board**, which is why this sits at 55 not 60. |
| 8/22 | WSH @ MIA (Irvin/E.Pérez) | YRFI | 56% | _model-only_ | TBD | **Irvin 5.80 / 1.36, L3 14.2 IP / 11 ER = 6.75.** Eury Pérez (3.23/1.11, L3 2.00) is a strong NRFI half, so this is one-sided — the same asymmetry the main build priced into a Miami ML, and the 8/20 lesson says those are different objects. |
| 8/22 | NYM @ CWS (C.Scott/Castillo) | YRFI | 57% | _model-only_ | TBD | Both halves worse than they look. **Castillo 4.99 / 1.37**; **Scott's 3.51 is stale-LOW — L3 15.1 IP / 10 ER = 5.87** incl. 4.0 IP / 4 ER on 8/10. |
| 8/22 | CIN @ AZ (Lowder/Soroka) | YRFI | 57% | _model-only_ | TBD | **Lowder 5.17 / 1.49** — second-worst WHIP among named starters, and WHIP is the 1st-inning metric. ⚠ Soroka is two starts off a two-month absence; a ramping arm's command is least settled early, so his 2.93 suppresses less than it implies. |
| 8/22 | LAA @ TEX (R.Johnson/Bradford) | YRFI | 58% | _model-only_ | TBD | **Ryan Johnson 6.41 / 1.54** is the worst combined line with real volume. ⚠ **Bradford's 2.93 rests on 15.1 IP / 3 GS with a 1.43 WHIP** — the ERA is not evidence, the WHIP is, and it agrees. |
| 8/22 | STL @ PHI (Q.Mathews/Painter) | YRFI | **60%** | _model-only_ | TBD | ⬆ **16:00 UPDATE — E4 LIFTED.** `recheck.py`: *AWAY probable now posted: Quinn Mathews (was TBA)*. The read **strengthens rather than flips**: Mathews' **1.56 WHIP** joins Painter's **1.55**, giving this game the **two worst WHIPs among named starters on the slate**, and WHIP is the 1st-inning metric. ⚠ Mathews' line rests on **2 GS / 9.0 IP**, so it is thin evidence in both directions — held to 60, not pushed higher. **58% → 60%.** |
| 8/22 | CHC @ SEA (Peterson/K.Anderson) | YRFI | 58% | _model-only_ | TBD | ⚠ **E4-class: Kade Anderson returns an EMPTY 2026 StatsAPI line — an MLB debut.** Highest-variance 1st inning on any board; **Peterson 5.29 / 1.53** supplies the other half. **Do not price at 16:00 without confirming the debut.** |
| 8/22 | SF @ BOS (Tidwell/Sandoval) | YRFI | 62% | _model-only_ | TBD | WHIP read end to end. **Sandoval's 1.85 is the worst on the slate by 0.31**, L3 15.0 IP / 11 ER = 6.60 incl. 4.0 IP / 7 ER on 8/16. Tidwell (1.22 over 3 GS) is thin evidence, not a suppressor. |
| 8/22 | CLE @ COL (Bibee/G.Hughes) | YRFI | **65% model / 58.2% derived** | **Over 0.5 −140 (FanDuel)** — no-vig **56.7%**, edge **+1.5pp** → ⛔ **NO BET (under the +2pp gate)** | TBD | ⭐ Board's strongest YRFI: Coors, the slate's highest total by 2.5 runs, and **Gabriel Hughes' L3 = 13.1 IP / 19 ER = 12.83**. Same construction that cashed here yesterday. Bibee (4.01/1.15) is the better half at a 5.50 L3. ⬆ **16:00 UPDATE — PRICED (1 credit) AND NOT PROMOTED; this row is the 8/12 audit in miniature.** Best pair **Over 0.5 −140 @FanDuel / Under 0.5 +125 @BetOnline.ag → no-vig 56.7% YRFI**. ⚠ **The 65% was a hand-model number, which doctrine treats as the `*`-equivalent of a TrueP.** Re-anchored to the market baseline, the only registered tag that applies is **`hitter_park_over+1.5`** (HALVED 8/19 from +3) — and **`wind_out_over` is RETIRED at 0.0pp**, despite Coors showing **10 mph out to RF**, which is precisely the trap that retirement exists to close. **TrueP 58.2%, edge +1.5pp — under the gate. NO BET.** The 6.8pp collapse is not a re-analysis; it is what happens when a number is required to name its adjustments. |
