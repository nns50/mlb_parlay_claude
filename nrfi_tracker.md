...
| 8/19 | ATL @ MIN (Smith-Shawver/Bradley) | YRFI | 57% | _model-only_ | TBD | Both halves are soft: **Smith-Shawver has 4.1 IP all season and last pitched 7/29** (three weeks idle — likely a piggyback), and **Bradley's last three read 15 IP / 11 ER (6.60)** against a 3.98 season line. Two first-inning question marks in a park with wind out. |
| 8/19 | CWS @ CHC (Newcomb/Holmes) | NRFI | 58% | _model-only_ | TBD | ⛔ **E5 — Chicago's White Sox half is a bullpen game**: Newcomb's last three outings are 1.0, 1.1 and 2.1 IP; he is a reliever listed as a probable. An opener's first inning is his *best* inning, and **Holmes (1.07) is clean**. **Wrigley wind 7 mph IN from LF at 72°F** supports it. |
