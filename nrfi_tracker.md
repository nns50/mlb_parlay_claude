...
| 8/22 | TOR @ NYY (Cease/Weathers) | NRFI | **64%** | _model-only_ | TBD | ⭐ Board's strongest lean either way. Cease 2.42/1.06/13.14 K/9 (L3 18.1 IP / 5 ER, 27 K) vs Weathers 3.56/1.19 with a L3 of **19.0 IP / 2 ER = 0.95**. 6.5 is the lowest full-game total on the slate by a full run, and the only live weather read on the board — **74°F, wind 6 mph IN from CF** — points the same way. |
| 8/22 | ATL @ MIL (M.Pérez/Henderson) | NRFI | 62% | _model-only_ | TBD | Two best WHIPs on the slate facing each other. **Henderson 2.70 / 0.87** (L3 19.1 IP / 6 ER, 21 K) vs **Martín Pérez 3.15 / 1.19** (L3 14.0 IP / 4 ER = 2.57). Retractable roof removes weather from the read. |
