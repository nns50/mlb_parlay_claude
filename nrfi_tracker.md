...
| 8/21 | WSH @ MIA (Lord/Gusto) | NRFI | 53% | _model-only_ | TBD | ⚠ **E5 — Washington's listed probable Brad Lord is a swingman**: 3 GS across 62. |
| 8/21 | TB @ BAL (F.Peralta/T.Rogers) | YRFI | 60% | _model-only_ | TBD | ⭐ **Strongest YRFI lean that is not Coors. |
| 8/21 | NYM @ CWS (Manaea/Burke) | YRFI | 55% | _model-only_ | TBD | **Burke's 3. |
| 8/21 | DET @ KC (Melton/Cameron) | NRFI | 62% | _model-only_ | TBD | ⭐ **Second-strongest NRFI, and the cleanest recent-form pair on the board. |
| 8/21 | ATH @ HOU (Ginn/Wesneski) | YRFI | 55% | _model-only_ | TBD | **Houston's half is the read. |
| 8/21 | LAA @ TEX (Detmers/Gore) | NRFI | 59% | _model-only_ | TBD | **Both season lines are stale-HIGH and both arms are hot — the rare case where E2 fires in the same direction on both halves. |
| 8/21 | CLE @ COL (Cantillo/Gordon) | YRFI | 64% | _model-only_ | TBD | ⭐ **Board's strongest lean in either direction: Coors Field plus the two worst WHIPs on the slate. |
| 8/21 | CIN @ AZ (Lodolo/E.Rodriguez) | YRFI | 56% | _model-only_ | TBD | ⚠ **E2 fires against Arizona: Eduardo Rodriguez's 2. |
| 8/21 | MIN @ SD (Prielipp/TBD) | YRFI | 55% | _model-only_ | TBD | ⚠ **E4 — San Diego have not named a probable, so half this read is unresolved. |
| 8/21 | PIT @ LAD (Chandler/Yamamoto) | NRFI | 56% | _model-only_ | TBD | **Yamamoto owns his half — 2. |
| 8/21 | CHC @ SEA (Boyd/Hancock) | YRFI | 54% | _model-only_ | TBD | **Thinnest lean on the board, logged for calibration rather than conviction. |
