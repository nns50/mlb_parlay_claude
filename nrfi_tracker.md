...
| 8/20 | STL @ CIN (McGreevy/Singer) | YRFI | 55% | _model-only_ | TBD | GABP is a genuine YRFI park; Singer 4.66 / 1.44 last three at 4.50 supports the soft-half read, though his last three are 6/3, 6/3, 6/3 — remarkably steady. McGreevy 3.48 / 1.22 with 6.20 K/9 limits damage but does not miss bats. Neither top-of-order elite. |
| 8/20 | SF @ CLE (Roupp/Williams) | NRFI | 58% | _model-only_ | TBD | ⭐ Williams' 11.48 K/9 over 149 IP owns the home half — whiffs are the cleanest 1st-inning suppressant. Progressive Field suppresses; wind 7 mph IN From RF at 77°F reinforcing. SF are 51-75, −74 differential — the worst offence on the board. Roupp 1.30 WHIP is the drag. |
| 8/20 | TOR @ TB (Bieber/Seymour) | NRFI | 57% | _model-only_ | TBD | Dome, no weather input. Seymour 10.74 K/9 owns the home half; last three 6/2, 6/1, 6/3. Bieber 4.99 / 1.56 season is stale-high — his last three at 3.64 refutes the aggregate. Neither top-of-order elite. |
