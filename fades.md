...
| D6 | **NYM ML favored vs MIA, priced beyond team-quality** — REJECT-as-anchor (NEW 8/1/26) | Recurring series pattern: NYM (47-64, RDiff −52) keeps getting priced as home fav vs MIA (56-55, RDiff +7) regardless of which NYM starter (McLean, Peralta, now Thornton) — the number looks driven by home field/recency, not a real team-quality edge | **8/1/26** | **8/1/26** | W (7/31: Peralta REJECT correct, MIA won 5-2) · L (7/30: REJECT missed, NYM won 4-2) · W (7/26: McLean REJECT correct, MIA won 5-2) | **NEW / WATCH — 2-1 (67%) across 3 sightings.** Below the 2-3 process-lesson promotion bar's upper end; one more sighting before treating as a confirmed matchup trap. 8/1 build takes the actual +EV side (MIA ML +118, custom+4pp) rather than just rejecting NYM. |
