...
| D5 | **Bullpen-game opponent ≠ ML boost** — do NOT shade a fav UP because the other side has an opener/no real starter | The opposing pen can shut your offense down AND the lineup can tee off on your ace; a no-starter opponent is variance, not a free upgrade | **6/4/26** | **6/9/26** | **W (8/7: DET −126 BLOCKED off SF's Brubaker bullpen game (0 GS in 54.0 IP) — **DET LOST 5-2**; the no-boost rule paid a third time, tally now 3-0)** · | **W (6/9: ATL −148 vs CWS's Eisert bullpen game; held ATL 60% NOT boosted — still LOST 5-6, killed the user's $30 parlay. The discipline was right but the leg was just thin/-EV-ish; 2nd validation of the spot)** · **W (6/4: bumped ATL 67→69% vs TOR's Fluharty pen game; lost 7-2)** | **ACTIVE — 3-0, CONFIRMED firm rule** (8/7 added a non-ATL sighting: DET fav vs SF's bullpen game, DET lost 5-2 — the rule now has a data point outside the original ATL pair, which is what it needed) |
