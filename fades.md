...
- **8/6/26 — `hitter_park_over` / `pitcher_park_under` as a THESIS (not a tiebreaker) is now
  twice-confirmed as weak (2 sightings — one more and it promotes).** 8/5's review found
