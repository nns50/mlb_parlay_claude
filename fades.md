...
| C6 | **Over-fading elite-K aces** (META-fade: fade our own over-fade) | We faded Sanchez 9 K, Burns 9 K (6/3), Harrison 12 K (6/2) — all hit | 6/3/26 | **6/9/26** | **6/9 mixed calibration (didn't bet, observed): Cease 11K ✅over, Skenes 7K ✅over6.5, Wheeler 5K ❌under; Chase Burns STILL LIVE (6 K thru 5 IP — TBD, NOT settled). 2 of 3 settled aces cashed.** · 3 straight fades MISSED 6/2-6/3 → correction installed | **ACTIVE CORRECTION — but NOT a blanket "always play ace K-Overs"; even elite arms are a coin-flip-plus once start-length (C3) bites. Price each pre-game + pick by edge; the standard line is not a lock** |
