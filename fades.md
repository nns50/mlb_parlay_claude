...
|----|------|--------|-------|----------|-----|--------|
| D1 | **The +200-chase 3rd leg** (bolting a leg onto a clean 2-legger to stamp +200) | Drops floor ~15-18pp; the chase leg keeps busting | 5/30/26 | **7/25/26** | **L (7/25: LAD ML chase leg on top of Cease K-Over + TB ML WON — Tier 3 cashed at +416 despite the flagged floor drop 36.1%→22.0%)** · W (6/3 TB chase leg busts, LAD+PHI cashes) · W (6/2 declining the +270 saved us) · W (6/1 chase cost us) | **ACTIVE — 3-1, still the strongest fade on the board (75%); 7/25 is a reminder the chase leg CAN hit — the doctrine is about floor/EV, not a guarantee, so keep flagging the drop even when it happens to pay off.** |
