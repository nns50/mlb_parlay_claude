...
| C6 | **Over-fading elite-K aces** (META-fade: fade our own over-fade) | We faded Sanchez 9 K, Burns 9 K (6/3), Harrison 12 K (6/2) — all hit | 6/3/26 | **6/9/26** | **6/9 mixed calibration (didn't bet, observed): Cease 11K ✅over, Skenes 7K ✅over6.5, but Wheeler 5K ❌under AND Chase Burns 6K in 4.2 IP ❌under6.5 (pulled early — start-length tail). 2 of 4 elite K-Overs cashed.** · 3 straight fades MISSED 6/2-6/3 → correction installed | **ACTIVE CORRECTION — but NOT a blanket "always play ace K-Overs"; the 6/9 data shows ~50% even for elite arms once start-length (C3) bites. Price each pre-game + pick by edge; the standard line is a coin-flip-plus, not a lock** |
