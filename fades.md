...
|----|------|--------|-------|----------|------------------------------|--------|
| A1 | **Cubs** | **L15 6-9 (.400), −16 run diff (6/16); host COL again today (Assad vs Sullivan).** | 5/25/26 | **6/17/26** | **W (6/16: lost 2-5 to COL at home as −190 heavy fav — fade HIT)** · L (6/15: beat COL 5-4 at home as heavy fav — fade MISSED) · L (6/11: beat COL 9-3 @ COL as −147 fav) · W (6/10: lost 2-3 @ COL as −147 fav) · W (6/9: lost 3-7 @ COL) · L (6/6: beat SF 3-2) · W (6/5) · L (6/4) | **ACTIVE** — fade-as-fav 5-4 recent; the 6/16 −190 home loss to COL re-affirms it. L15 now **6-9/−16** (cooled further, clearly sub-.500). CHC favored vs COL again today = excluded as anchor; don't lay them. |
...
|----|------|--------|-------|----------|-----------|--------|
| B1 | **White Sox** | 38-33; L10 6-4, +2 run diff (6/16) — re-heating cooled by the NYY blowout | 5/28/26 | **6/16/26** | **L (6/16: lost 2-12 @ NYY as +161 road dog — dog value MISSED, blown out)** · W (6/14: beat LAD 6-4 as home dog — took the series) · L (6/13: lost 1-7 to LAD) · W (6/12: beat LAD 8-2 as +178 dog) · W (6/10: beat ATL 2-1) · W (6/9: beat ATL 6-5) · L (6/7) · W (6/6) · L (6/5) · W (6/4) | **ACTIVE but cooling** — dog value 6-3 recent; the 6/16 2-12 @ NYY beatdown trimmed run diff +16→+2. @ NYY again today (CWS +161, Kay vs Rodón) — no dog-value lean into Rodón. |
...
| B4 | **Tigers** | NEW 6/3: dog value — swept TB; 9-3 @ HOU 6/15; but lost 2-4 @ HOU 6/16 | 6/3/26 | **6/17/26** | **L (6/16: lost 2-4 @ HOU as road dog — dog value MISSED)** · W (6/15: won 9-3 @ HOU as +159 road dog) · W (6/3 won 7-2 as +122 dog) | **WATCH (dog value 2-1)** — DET @ HOU again today (Mize vs Lambert). Standalone-only if leaned; the 6/16 loss tempers the run. |
...
| C6 | **Over-fading elite-K aces** (META-fade: fade our own over-fade) | We faded Sanchez 9 K, Burns 9 K (6/3), Harrison 12 K (6/2) — all hit | 6/3/26 | **6/16/26** | **6/16: Cease O6.5K (PLAYED as Tier-1 standalone) ✅ 7 K in only 5.0 IP — cashed despite the short start; the elite K-RATE (13.63 K9) carried it past 6.5 even with start-length left tail.** · 6/9: Cease 11K ✅, Skenes 7K ✅over6.5, Chase Burns 7K/5.1IP ✅over6.5 (Tier-1 rec), Wheeler 5K ❌under — 3 of 4 cashed · 3 straight fades MISSED 6/2-6/3 → correction installed | **ACTIVE CORRECTION — 6/16 Cease (7K/5IP) re-validates: an elite K-rate clears the line even on a short start. Don't fade elite arms' K-Overs by reflex; price each + play by edge (NOT a blanket "always play" — Wheeler missed on start-length).** |
...
| D4 | **Favorite ML w/ own SP ERA ~5.00+** (esp. two-bad-SP shootouts) | High-variance; favorite can be blown out as the "right" side | 5/28/26 | **6/17/26** | **L (6/16: MIL −148, Gasser 6.38 own-SP trap → MIL WON 2-1 vs CLE; trap fav cashed)** · L (6/15: LAD −166, Lauer 5.47 → LAD WON 4-3 vs TB) · L (6/7: PHI −161, Nola 5.55 → PHI WON 9-5) · W (6/6: PHI −136, Painter 5.74 → lost 3-6) · W (6/5: AZ −134, Kelly 5.06 → 1-14) · W (5/28 DET/Flaherty 5.94 → 7-1) | **ACTIVE — 3-3, REJECT-AS-ANCHOR ONLY** (now 3 straight misses 6/7/6/15/6/16; the gate is high-variance by design — keep declining these as a clean anchor, but it is NO LONGER a "bet against the trap fav" signal — at .500 the trap fav is a coin flip, not a fade) |
...
- **A1 (Cubs as fav):** **5-4** — re-affirmed 6/16 (CHC −190 lost 2-5 to COL at home); L15 6-9/−16, strongest active team-fade-as-fav again.
