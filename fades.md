...
|----|------|--------|-------|----------|------------------------------|--------|
| A1 | **Cubs** | **L15 7-8 (.467), −8 run diff (6/15); home −190 vs COL today (Cabrera vs Feltner).** | 5/25/26 | **6/16/26** | **L (6/15: beat COL 5-4 at home as heavy fav — fade MISSED)** · L (6/11: beat COL 9-3 @ COL as −147 fav — fade MISSED) · W (6/10: lost 2-3 @ COL as −147 fav) · W (6/9: lost 3-7 @ COL) · L (6/6: beat SF 3-2) · W (6/5) · L (6/4) | **ACTIVE but cooling as a fade** — fade-as-fav now 4-4 recent (missed 6/11 + 6/15, both vs COL); L15 7-8/−8 still sub-.500. Today CHC −190 vs COL again = excluded as anchor, but the recent log says don't *bet against* them either. Re-verify run-diff next run; near a NEUTRAL transition. |
...
| B4 | **Tigers** | NEW 6/3: heating as a dog — swept TB; won 9-3 @ HOU 6/15 as a road dog | 6/3/26 | **6/16/26** | **W (6/15: won 9-3 @ HOU as +159 road dog — dog value HIT, blew HOU out)** · W (6/3 won 7-2 as +122 dog) | **WATCH (emerging dog value — 2-0)** — DET hitting well as a dog; @ HOU again today (DET +159). Standalone-only if leaned. |
