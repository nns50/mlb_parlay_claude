...
| 6/10 | DET ML (Valdez, vs MIN) — Build B | ML-fav | -163 | 61.5% | 60.8% | +0.7 | **TBD** — Build B leg; lineup-lock revealed Valdez (E4/D5 lifted). Valdez 5K/5IP last out 6/5; MIN cold L10 3-7 + weak Paredes. Grade: **~fair/thin (under gate)** | N | — | P |
| 6/10 | ATL ML (Sale, vs CWS) — Build B | ML-fav | -142 | 59.4% | 57.4% | +2.0 | **TBD** — Build B Tier 1 standalone (best clean edge); lineup-lock revealed Sale. Elite ATL + Sale (6K/5.2IP last out) vs B1 CWS dog (beat ATL 6-5 6/9, home — risk flag). Grade: **+EV (clears +2pp gate, thin)** | N | — | P |
