...
| 6/13 | TEX ML (deGrom, @ BOS) | ML-dog | +105 | 53% | 47.7% | **+5.3** | **TBD** — Build A Tier 1 standalone (sharpest edge on board). deGrom 3.18/10.7 K9 fresh (6/7: 6IP/0ER) > Ranger Suarez; TEX hotter (L10 7-3) priced a dog. Grade: **+EV (clears gate)** | N | — | S |
| 6/13 | MIL ML (Drohan, vs PHI) | ML-fav | -143 | 60% | 57.6% | +2.4 | **TBD** — Build A Tier 2/3 anchor + **bankroll attempt-4 roll 3**. MIL 42-25/+109 elite; Drohan 3.11 fresh (6/7: 6.1IP) vs PHI's Nola 5.55 (D4 trap on PHI's side). Grade: **+EV (clears +2pp gate)** | N | — | S |
| 6/13 | AZ ML (Soroka, @ CIN) | ML-fav | -142 | 58% | 57.3% | +0.7 | **TBD** — Build A Tier 2 floor leg. Soroka 3.28 fresh (6/7: 7IP/1ER/6K) vs cold CIN (L10 3-7, −57) + Lowder 5.01. Line shortened −125→−142 overnight, eating the edge. Grade: **near-fair (under gate, high-floor)** | N | — | P |
