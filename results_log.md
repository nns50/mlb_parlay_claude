...
| 6/11 | LAD ML −167 × Ohtani O1.5 TB −125 (Build C Tier 2 — highest floor) | +188 | 33.5% | 40.7% | +6.0 | **TBD** — same-game pos corr (ρ≈+0.30); EV +17.2%. Best win chance (~40.7%) but lands +188 (just shy of +200). Supersedes Build B at refreshed prices. |
| 6/11 | LAD ML −167 × Freeman O1.5 TB −115 (Build C Tier 3 — genuine +200) | +199 | 31.0% | 38.3% | +4.8 | **TBD** — same-game pos corr; EV +14.4%; clears +200 essentially exactly, ~2.4pp lower floor than the Ohtani version. |
