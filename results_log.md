...
| 6/9 | MIA ML (Meyer, vs AZ) | ML-fav | -129 | 59% | 56.5% | +2.5 | TBD — Build A Tier 1 standalone + Tier 2/3 leg + bankroll roll 1 (attempt 3); Meyer 2.81/9.90 K9, 6-0 + AZ cold/Gallen 5.32. Grade: **+EV (clears gate)** | N | | S |
| 6/9 | ATL ML (Holmes, vs CWS) | ML-fav | -148 | 60% | 58.3% | +1.7 | TBD — Build A Tier 2/3 partner; best team 45-21/+116, Holmes 3.86 > Fedde 4.94/1-5. Grade: **+EV (thin, under std gate — parlay leg only)** | N | | P |
| 6/9 | ATL ML + MIA ML (+200 build) | Parlay (indep) | +197 | 35.4% | 33.6% | +1.8 | TBD — Build A Tier 2 = Tier 3 (the disciplined 2-leg hits +197, no chase leg). Grade: **+EV (thin), high-floor +200** | N | | P |
