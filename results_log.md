...
| 6/18 | MIN ML (Joe Ryan, @ TEX) — Build A | ML-fav | -120 | 56.5% | 53.4% | **+3.1** | **TBD** — Build A Tier 1 standalone (sharpest single ML edge). Joe Ryan 3.17/10.06 K9 ace (9-9-5-8 K last four) vs young Leiter; ace-edge +3pp. Joe Ryan K-Over the likely 16:00 Tier-1. Grade: **+EV (clears gate)** | N | — | S |
| 6/18 | NYY ML (Weathers, vs CWS) — Build A | ML-fav | -149 | 60.5% | 58.4% | **+2.1** | **TBD** — Build A Tier 2/3 anchor + bankroll roll 1. NYY 45-27/+122 elite, home vs a CWS in freefall (run diff +16→−3). Weathers 4.36 shaky (no ace-edge); team/opponent-driven. Grade: **+EV (clears gate, thin)** | N | — | P |
| 6/18 | ATL ML (Pérez, vs SF) — Build A | ML-fav | -132 | 57% | 56.0% | +1.0 | **TBD** — Build A Tier 2 leg. Pérez 2.90 edge vs Roupp + SF 31-43; ⚠ SF swept the 6/17 DH + ATL cooling (L10 4-6). Grade: near-fair (cooling flag) | N | — | P |
| 6/18 | NYY ML −149 × ATL ML −132 (Build A Tier 2 — highest floor) | Parlay | +194 | 34.5% | 34.5% | +0.5 | **TBD** — two home favs (NYY elite + Pérez edge). parlay.py: edge +0.5pp, EV +1.4%, **34.5% floor** → best WIN CHANCE (lands +194, under +200). | N | — | P |
| 6/18 | NYY ML −149 × MIN ML −120 (Build A Tier 3 — the +200 ask) | Parlay | +206 | 34.2% | 34.2% | **+1.6** | **TBD** — the +200 build. parlay.py: edge +1.6pp, EV +5.1%, **34.2% floor**; both legs individually gate-clear. Rare slate where +200 costs ~0 floor vs Tier 2 (Joe Ryan's +3.1pp replaces ATL's cooling +1.0pp). **Recommended +200.** | N | — | P |
