...
| 6/9 | ATL ML + MIA ML (+200 build) | Parlay (indep) | +195 | 35.4% | 33.9% | +1.5 | **❌ LOST (−$30): MIA W, ATL L (D5 trap).** PLAYED, $30 @ +195. MIA leg cashed; ATL killed it. K-Over reality: MIA+**Cease** O6.5K (11K) or +**Skenes** O6.5K (7K) WOULD'VE cashed, but +**Burns** O6.5K (4.2 IP/**6 K** — start-length tail realized) WOULD'VE LOST; **Wheeler 5K** also under. So the codified swap is right *as a process* (price + pick by edge) but NOT a free win — 2 of 4 candidate K-Overs hit. Grade: **+EV thin (action not value) — lost on the thin ATL leg, as flagged** | Y | | P |
