...
| 6/18 | NYY ML (Weathers, vs CWS) — Build A→B | ML-fav | -149 | 60.5% | 58.4% | **+2.1** | **TBD** — Build A/B Tier 1 anchor + bankroll roll 1. NYY 45-27/+122 elite, home vs CWS in freefall (run diff +16→−3). Weathers 4.36 shaky (no ace-edge); team/opponent-driven. CLV+: no-vig firmed 58.4→59.7%. Grade: **+EV (clears gate, thin)** | N | **+** | P |
...
| 6/18 | SEA ML (Woo, vs BAL) — Build B | ML-fav | -120 | 55.5% | 54.3% | +1.2 | **TBD** — Build B +200 leg. Woo elite K stuff but shelled by BAL 6/11 (5IP/7ER, 2nd mtg/7d, C2 flag); market repriced −141→−120 so −120 marginally +EV. ⚠ Warmup at 16:00. Grade: near-fair (2nd-meeting flag, thin +EV) | N | + 85%cl | S |
| 6/18 | NYY ML −149 × SEA ML −120 (Build B Tier 2=3 — the +200 ask) | Parlay | +206 | 33.6% | 32.6% | +0.9 | **TBD** — rebuilt +200. parlay.py: edge +0.9pp, **EV +2.9%, 33.6% floor** — the ONLY +200-range build that is +EV (NYY×PHI −1.3%, NYY×Turner-HRR −5.5% rejected). **Recommended +200; place SEA before ~16:11 ET FP.** | N | — | P |
