...
| 6/11 | NYM ML (Scott, vs STL) | ML-fav | -138 | 56.6% | 59% | +2.4 | **TBD** — Build A Tier 1 standalone + Tier 2 leg + **bankroll attempt-4 roll 1**; Scott 2.50/10.25 K9 ace edge vs Dobbins (1 GS unknown). STL hot (W6) is the risk. Grade: **+EV (clears +2pp gate)** | N | — | S |
...
| 6/11 | MIA ML (Phillips, vs AZ) | ML-fav | -115 | 52.4% | 54% | +1.6 | **TBD** — Build A Tier 3 (+200) second leg; MIA hot L10 7-3/W4, shut out AZ 8-0 yest; AZ cold L10 3-7/−22. Phillips < Kelly (why only +1.6pp). Grade: **thin +EV** | N | — | P |
...
| 6/11 | NYM ML −138 × LAD ML −163 (Build A Tier 2) | +178 | — | — | — | TBD (highest-floor 2-leg; true comb **36.6%**, EV **+1.8%** — best win chance, under +200) |
| 6/11 | LAD ML −163 × MIA ML −115 (Build A Tier 3 — the +200) | +202 | — | — | — | TBD (highest-floor genuine +200; true comb **33.5%**, EV **+1.0%**; ~3pp floor drop vs Tier 2 — clean 2-leg, not a D1 chase) |
