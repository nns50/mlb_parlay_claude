...
| 6/17 | LAD ML (Ohtani, vs TB) | ML-fav | -158 | 63% | 60.3% | **+2.7** | **TBD** — Build A Tier 1 standalone + Tier 2/3 anchor + bankroll roll 4 (the 4-win target). Ohtani 1.06 ERA / 0.84 WHIP / 9.71 K9 (best arm on the slate), LAD 47-27/+143 best NL team, home; ace-edge +3pp capped for McClanahan upside. Grade: **+EV (clears gate)** | N | — | S |
| 6/17 | AZ ML (E.Rodriguez, vs LAA) | ML-fav | -165 | 62% | 60.9% | +1.1 | **TBD** — Build A Tier 2 floor leg. E-Rod 2.55 ERA vs LAA (30-44)/rookie Aldegheri; last start short (2.2 IP 6/12 — slight flag). Thin (under +2pp gate) — pairs with LAD for the 2-leg, not a standalone. Grade: **near-fair (under gate)** | N | — | P |
...
| 6/17 | **LAD ML −158 × AZ ML −165 (Build A Tier 2 — highest floor, RECOMMENDED 2-leg)** | +162 | 39.1% | 39.1% | **+0.9** | **TBD** — two clean ace-edge home favorites (Ohtani 1.06 + E-Rod 2.55), no D4 trap. `parlay.py`: edge +0.9pp, EV +2.4%, **39.1% floor** → best WIN CHANCE (under +200). |
