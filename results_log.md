...
| 6/19 | deGrom/TEX ML (vs SD) — Build A Tier 1 | ML-fav | -155 | 62% | 59.3% | **+2.7** | **TBD** — Build A Tier 1 standalone (sharpest clean edge). deGrom 3.17/0.99/10.45 K9 healthy ace (6 IP each last 3) vs weak Vásquez/SD. Grade: **+EV (clears gate).** | N | = 59%cl (Build B: −153 close, no-vig 59% — flat, dead-band) | S |
| 6/19 | Soroka/AZ ML (vs MIN) — Build A Tier 2 + bankroll roll 1 | ML-fav | -167 | 63.5% | 61.1% | **+2.4** | **TBD** — Build A Tier 2 leg + bankroll roll 1 (attempt 7). Soroka 3.11/8-3, 7IP/1ER/7K last out, vs MIN rookie Prielipp (likely debut). Grade: **+EV (clears gate).** | N | = 61%cl (Build B: AZ −165 close, our-side no-vig 60.8% — flat; auto-capture's "−39%cl" was MIN/opp side, corrected) | S |
| 6/19 | deGrom Over 6.5 K (vs SD) — Build A Tier 3 leg | K-Over | -102 | 50% | 48.1% | +1.9 | **TBD** — Build A Tier 3 stack leg; coin-flip standalone (per-start avg ~6.4 K, recent 8/6/5). Value is in the same-game correlation, NOT the standalone edge. PENDING LINEUP (16:00 lock). Grade: ~fair standalone, +EV only via the stack. | N | — | S |
| 6/19 | deGrom/TEX ML −155 × Soroka/AZ ML −167 (Build A Tier 2 — highest-floor 2-leg) | Parlay | +163 | 39.4% | 39.4% | +1.4 | **TBD** — highest-floor clean 2-leg (two ace-edge home favs); lands +163 (under the +200 ask — favs cluster at −155/−167). parlay.py: edge +1.4pp, EV +3.6%. | N | — | P |
| 6/19 | deGrom/TEX ML −155 × deGrom O6.5K −102 (Build A Tier 3 — the +200 ask) | Parlay (+corr) | +226 | 38.3% | 30.7% | **+7.6 (corr)** | **TBD** — same-game positive-correlation stack (ρ≈+0.30 adds +7.3pp). parlay.py: true combined 38.3% vs +226 price, edge +7.6pp, EV +24.7%. The 6/17 NYY+Rodón template. PENDING LINEUP; take better of independent vs SGP. | N | — | P |
