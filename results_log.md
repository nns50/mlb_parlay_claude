...
| 6/10 | LAD ML (Ohtani, @ PIT) | ML-fav | -195 | 67% | 65.3% | +1.7 | **TBD** — Build B Tier 2/3 anchor + **bankroll roll 3** (highest floor on the evening board; Ohtani ace + PIT cooling/B2 blown out 12-3 on 6/9). Edge borderline (+1.7–2pp w/ ace-credit). Grade: **thin +EV (ace-edge floor leg)** | N | − 54%cl | P |
| 6/10 | PHI ML (Luzardo, @ TOR) | ML-fav | -132 | 57% | 55.6% | +1.4 | **TBD** — Tier 3 +200 second leg; Luzardo (shaky 6/5: 5 ER) vs Scherzer, near-fair. Grade: **~fair/thin** | N | − 54%cl | P |
| 6/10 | SD ML (King, vs CIN) | ML-fav | -156 | 58% | 59.7% | −1.7 | **TBD** — scan REJECT: SD ice-cold L10 2-8, lost to CIN 6/9; edge negative. Grade: **-EV reject** | N | — | S |
| 6/10 | DET ML (Valdez, vs MIN) — Build B | ML-fav | -163 | 61.5% | 60.8% | +0.7 | **TBD** — Build B leg; lineup-lock revealed Valdez (E4/D5 lifted). Valdez 5K/5IP last out 6/5; MIN cold L10 3-7 + weak Paredes. Grade: **~fair/thin (under gate)** | N | = 61%cl | P |
| 6/10 | ATL ML (Sale, vs CWS) — Build B | ML-fav | -142 | 59.4% | 57.4% | +2.0 | **TBD** — Build B Tier 1 standalone (best clean edge); lineup-lock revealed Sale. Elite ATL + Sale (6K/5.2IP last out) vs B1 CWS dog (beat ATL 6-5 6/9, home — risk flag). Grade: **+EV (clears +2pp gate, thin)** | N | + 58%cl | P |
...
| 6/10 | TB ML −141 × PHI ML −132 | +201 | — | — | — | PARTIAL (Build A Tier 3 — TB leg **W**; PHI leg TBD this evening). Floor dropped ~11pp vs Tier 2 to stamp +200 |
| 6/10 | LAD ML −195 + ATL ML −142 (Build B Tier 2) | +158 | — | — | — | TBD (highest-floor 2-leg; true comb **39.5%**, EV +1.8% — recommended highest-chance +EV ticket) |
| 6/10 | LAD ML −195 × DET ML −163 × ATL ML −142 (Build B Tier 3) | +316 | — | — | — | TBD ("the +200-zone"; true comb **24.3%**, EV +1.1% — 3 quality favs but pays above +200; floor drops ~15pp vs Tier 2 — D1 trade-off) |
| 6/10 | ATL ML −147 × PHI ML −129 (Build C Tier 3 — the +200) | +198 | — | — | — | TBD (highest-floor genuine +200; true comb **33.3%**, EV −0.8% after line drift; PHI thin leg. Build C recommended +200 for win chance) |
| 6/10 | LAD ML −198 × ATL ML −147 (Build C Tier 2) | +153 | — | — | — | TBD (highest-floor 2-leg; true comb **39.2%**, EV −0.9% — drift turned it ~fair vs Build B +1.8%) |

**Units-tracked tickets (flat-1u rows): 14 tickets, record 7-7, staked 14.00u, returned 21.39u → P/L +7.39u, ROI +52.8%** (added 6/10 TB+Rasmussen SGP **WON** +1.81u — a pos-corr highest-floor ticket, the diversify-era template cashing again). Real-dollar USER builds: **6/8 PHI+Sánchez SGP WON** $10→$26.70 (**+$16.70**); **6/9 MIA+ATL LOST** $30→$0 (**−$30.00**). Real-$ build P/L to date = **−$13.30** (1-1). Calib leg-level: **ML-fav 12-6**, STANDALONE 0-1 vs PARLAY 17-8, recommended-not-played 27-10 (leaving edge on declined legs).
