...
| 6/16 | ATL ML (Holmes, vs SF) | ML-fav | -161 | 63% | 60.5% | **+2.5** | **TBD** (SF@ATL SUSPENDED 6/16 → resumes 6/17; leg still open) — Build B Tier 2 anchor. ATL 46-25/+107 elite vs SF 29-43/−56 (worst-ish); Holmes 4.05 ERA (short 3.2IP last start 6/9), wind blowing IN at Truist (suppresses). Good-team + bad-opponent, not purely opponent-driven. Grade: **+EV (clears gate)** | N | = 60%cl | P |
...
| 6/17 | AZ ML (E.Rodriguez, vs LAA) | ML-fav | -165 | 62% | 60.9% | +1.1 | **❌ LOST** (AZ 1-8 LAA, decided T9) — Build A Tier 2 floor leg; E-Rod (2.55) shelled by the LAA rookie matchup. The thin under-gate (+1.1pp) ~61% floor leg fell → killed the LAD×AZ 2-leg. Grade: **near-fair (under gate) — correctly flagged thin, LOST.** | N | — | P |
| 6/17 | SEA ML (Kirby, vs BAL) | ML-fav | -126 | 55% | 54.8% | +0.2 | **TBD** — Build A Tier-3 floor-dropper (≈+200 leg). Kirby 4.07 ERA (no trap) home vs BAL 34-40; ~fair, no edge. Used only to push the 2-leg to +193. Grade: **fair (no edge)** | N | − 54%cl | P |
...
| 6/17 | Carlos Rodón Over 5.5 K (vs CWS) — Build B | K-Over | -130 | 57% | 54.0% | **+3.0** | **TBD** — Build B Tier 1 standalone (sharpest single, non-ML; FanDuel). Over 5.5K in 4 of last 6, 7K each last 2 starts, recent K9 ~10.2; CWS K% vs LHP 23% (avg, no suppressor); YS wind 11 In From RF aids Ks. Mild start-length flag (6 IP recently). Grade: **+EV (clears gate)** | N | — | S |
| 6/17 | NYY ML (Rodón, vs CWS) — Build B | ML-fav | -164 | 63% | 61.5% | +1.5 | **TBD** — Build B Tier 2/3 anchor. NYY 44-27/+117 elite, home; Rodón fresh; B1 CWS-dog fade explicitly waived today → NYY cleared to lay. Thin standalone (under +2pp) but Tier-2 stack component. Grade: near-fair as single | N | — | P |
| 6/17 | NYY ML + Rodón O5.5K SGP (vs CWS) — Build B Tier 2 | Parlay (+corr) | +185 ind | 42.5% | 35.3% | **+7.4 (ind)** | **TBD** — Build B Tier 2 = BEST CHANCE ~+200. Same-game pos-corr (ρ≈+0.30 moderate), true comb 42.5% (+7.2pp vs naive product), EV +21% at independent product. Take SGP if ≥+160 else book as two singles. Grade: **+EV (clears anchor bar)** | N | — | P |
| 6/17 | NYY ML −164 × SEA ML −126 (Build B Tier 3 — literal single +200) | Parlay | +189 | 34.7% | 34.7% | +0.0 | **TBD** — two independent favs, ~fair/~0 edge. Costs ~8pp floor vs the Tier-2 stack (+200-chase tax, D1). Recommend Tier 2 over this. Grade: ~fair (no edge) | N | — | P |
...
| 6/16 | **ATL ML −161 × SEA ML −145 (Build B Tier 2 — highest floor, RECOMMENDED 2-leg)** | +174 | 38.4% | 38.4% | **+1.9** | **TBD** (SEA W 3-1; ATL leg from SUSPENDED SF@ATL still open → resumes 6/17) — two strong favorites. `parlay.py`: edge +1.9pp, EV +5.3%, **38.4% floor** → best WIN CHANCE (under +200). |
