...
| 6/19 | deGrom/TEX ML (vs SD) — Build A Tier 1 | ML-fav | -155 | 62% | 59.3% | **+2.7** | **TBD** — Build A Tier 1 standalone (sharpest clean edge). deGrom 3.17/0.99/10.45 K9 healthy ace (6 IP each last 3) vs weak Vásquez/SD. Grade: **+EV (clears gate).** | N | — | S |
| 6/19 | Soroka/AZ ML (vs MIN) — Build A Tier 2 + bankroll roll 1 | ML-fav | -167 | 63.5% | 61.1% | **+2.4** | **TBD** — Build A Tier 2 leg + bankroll roll 1 (attempt 7). Soroka 3.11/8-3, 7IP/1ER/7K last out, vs MIN rookie Prielipp (likely debut). Grade: **+EV (clears gate).** | N | — | S |
