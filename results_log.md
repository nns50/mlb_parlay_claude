...
| 6/10 | Rasmussen Over 4.5 K (vs BOS) | K-Over | -155 | 64% | 56.7% | +7.3 | **TBD** — Build A Tier 1 standalone (sharpest edge on board). 9 K last out 6/5; 8/12 starts 5+ K; BOS 22% K vs RHP (neutral). HP ump PENDING. Grade: **+EV (clears gate)** | N | — | S |
| 6/10 | TB ML (Rasmussen, vs BOS) | ML-fav | -141 | 60% | 57.2% | +2.8 | **TBD** — Build A Tier 2 leg + bankroll attempt-3 roll 2; Rasmussen ace form vs 27-38 BOS; not A-list. Grade: **+EV (clears gate)** | N | — | P |
| 6/10 | LAD ML (Ohtani, @ PIT) | ML-fav | -193 | 66% | 64.3% | +1.7 | **TBD** — scan: elite LAD + Ohtani, but edge under +2pp gate (PIT B2 dog value, cooling). Grade: **~fair/thin (declined as bankroll)** | N | — | P |
| 6/10 | PHI ML (Luzardo, @ TOR) | ML-fav | -132 | 57% | 55.6% | +1.4 | **TBD** — Tier 3 +200 second leg; Luzardo (shaky 6/5: 5 ER) vs Scherzer, near-fair. Grade: **~fair/thin** | N | — | P |
...
| 6/10 | TB ML −141 + Rasmussen O4.5K −155 (SGP, +corr) | +181 indep | — | — | — | TBD (Build A Tier 2; true comb **45.5%**, EV +27.8% — highest-floor ticket; take indep product or SGP ≥ +150) |
| 6/10 | TB ML −141 × PHI ML −132 | +201 | — | — | — | TBD (Build A Tier 3 — the literal +200; true comb 34.2%, edge +0.9pp thin; floor drops ~11pp vs Tier 2) |

**Units-tracked tickets (flat-1u rows, reconciled to calib.py): 13 tickets, record 6-7, staked 13.00u, returned 18.58u → P/L +5.58u, ROI +42.9%.** Real-dollar USER builds: **6/8 PHI+Sánchez SGP WON** $10→$26.70 (**+$16.70**); **6/9 MIA+ATL LOST** $30→$0 (**−$30.00**, the thin ATL/D5 leg killed a +1.5pp action ticket). Real-$ build P/L to date = **−$13.30** (1-1). Counting 6/8+6/9, recommended-build W/L = **7-8** — the parlay-tax evidence keeps accumulating (thin +200 builds bleed; the MIA *standalone* won).
