...
| 6/21 | SEA ML −123 (BOS @ SEA) — Tier 3 alt / standalone | ML-fav | -123 | **60.5%** | 54.0% | **+5.9** | **TBD** — Gilbert 3.49/9.76 K9 ace (10K last start 6/16); Tolle rookie; SEA 45-29 vs BOS 34-41. BetUS. Grade: **+EV** | N | — | S |
| 6/21 | PHI ML −175 × SEA ML −123 (Tier 3 cross-game) | Parlay | +185 | **42.4%** | 35.1% | **+7.3** | **TBD** — independent, parlay.py: true combined 42.4%, edge +7.3pp, EV +20.8%. Alt if Peterson prop unavailable. | N | — | P |
