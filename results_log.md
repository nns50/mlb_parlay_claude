...
| 6/17 | SEA ML (Kirby, vs BAL) | ML-fav | -126 | 55% | 54.8% | +0.2 | **TBD** — Build A Tier-3 floor-dropper (≈+200 leg). Kirby 4.07 ERA (no trap) home vs BAL 34-40; ~fair, no edge. Used only to push the 2-leg to +193. Grade: **fair (no edge)** | N | — | P |
