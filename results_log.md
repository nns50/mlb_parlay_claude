...
| 6/13 | TEX ML (deGrom, @ BOS) | ML-dog | +105 | 53% | 47.7% | **+5.3** | **TBD** — Build A Tier 1 standalone (sharpest edge on board). deGrom 3.18/10.7 K9 fresh (6/7: 6IP/0ER) > Ranger Suarez; TEX hotter (L10 7-3) priced a dog. Grade: **+EV (clears gate)** | N | − 40%cl | S |
| 6/13 | MIL ML (Drohan, vs PHI) | ML-fav | -143 | 60% | 57.6% | +2.4 | **TBD** — Build A Tier 2/3 anchor + **bankroll attempt-4 roll 3**. MIL 42-25/+109 elite; Drohan 3.11 fresh (6/7: 6.1IP) vs PHI's Nola 5.55 (D4 trap on PHI's side). Grade: **+EV (clears +2pp gate)** | N | − 39%cl | S |
| 6/13 | AZ ML (Soroka, @ CIN) | ML-fav | -142 | 58% | 57.3% | +0.7 | **TBD** — Build A Tier 2 floor leg. Soroka 3.28 fresh (6/7: 7IP/1ER/6K) vs cold CIN (L10 3-7, −57) + Lowder 5.01. Line shortened −125→−142 overnight, eating the edge. Grade: **near-fair (under gate, high-floor)** | N | − 53%cl | P |
| 6/13 | ATH ML (Estes, vs COL) | ML-fav | -167 | — | 61.1% | — | **REJECTED — SP-freshness FAIL** (Joey Estes: zero 2026 data, 9.82 ERA/2.00 WHIP in 11 IP 2025; unverifiable/unproven arm → two-shaky-SP game, not a safe "vs worst-team" anchor; E4/C3-adjacent). The overnight build wrongly anchored it. Grade: **correct reject** | N | — | S |
...
| 6/13 | MIL ML −143 × AZ ML −142 (Build A Tier 2 — highest floor) | +190 | 34.8% | 34.8% | +0.3 | **TBD** — two fresh-SP favs (Drohan 3.11 + Soroka 3.28); highest win chance ~34.8% but near-fair (AZ shortened under-gate). Lands +190, just under +200. |
| 6/13 | **MIL ML −143 × TEX ML +105 (Build A Tier 3 — the +200, RECOMMENDED)** | +248 | 31.8% | 31.8% | +3.1 | **TBD** — genuine +EV +200 build (EV +10.8%, clears the parlay-anchor bar). deGrom's +5.3pp dog edge carries it ABOVE the higher-floor Tier 2 in value. True comb 31.8%, ~3pp under Tier 2 for the +200 stamp + the +EV. |
