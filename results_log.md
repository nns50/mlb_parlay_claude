...
| 6/15 | PHI ML (Wheeler, vs MIA) | ML-fav | -193 | 67.5% | 64.8% | **+2.7** | **TBD** — Build A Tier 1 standalone + bankroll roll 2. Wheeler 2.22 ERA / 0.85 WHIP / 8.42 K9, fresh (6/9 @TOR 6IP/1ER/5K) vs MIA's Gusto. Ace-edge +3pp adj. The one clean +2pp edge on the board. Grade: **+EV (clears +2pp gate)** | N | − 63%cl | S |
| 6/15 | ARI ML (Nelson, vs LAA) | ML-fav | -125 | 55% | 54.3% | +0.7 | **TBD** — Build A Tier 2 second leg. Ryne Nelson home vs LAA rookie Walbert Ureña; ARI 36-35 vs LAA 29-43. Thin (under +2pp gate) — pairs with PHI for the 2-leg, not a standalone. Grade: **near-fair (under gate)** | N | — | P |
| 6/15 | WSH ML (Alvarez, vs KC) | ML-fav | -123 | 55% | 54.6% | +0.4 | **TBD** — scan row (3rd leg of the +200 stretch). WSH 37-35 home vs KC 29-43; thin. Grade: **near-fair (under gate)** | N | — | P |
| 6/15 | LAD ML (Lauer, vs TB) | ML-fav | -166 | 56% | 60.9% | **−4.9** | **TBD** — **REJECTED as anchor (D4 trap).** Lauer 5.47 ERA / 1.29 WHIP own-SP-5+ → high-variance shootout; market 60.9% discounted −5pp. Do NOT lay LAD as a clean fav tonight. Grade: **−EV anchor (D4) — correct reject** | N | + 63%cl | S |
| 6/15 | HOU ML (Teng, vs DET) | ML-fav | -121 | 54% | 54.0% | +0.0 | **TBD** — scan row. HOU 33-40 home vs DET rookie Melton; pure coin-flip, no edge. Grade: **fair (no edge)** | N | − 47%cl | P |
| 6/15 | PHI ML (Wheeler, vs MIA) — Build B reprice | ML-fav | -182 | 67.5% | 63.1% | **+4.4** | **TBD** — Build B: line moved −193→−182 (LowVig), no-vig 64.8%→63.1% so the **edge WIDENED to +4.4pp**. Same TrueP 67.5% (Wheeler 2.22/0.85, fresh 6/9). Tier 1 + bankroll roll 2. Grade: **+EV (best edge on the board)** | N | − 63%cl | S |
...
| 6/15 | TEX ML (Gore, vs MIN) | ML-fav | -148 | 58.5% | 58.5% | +0.0 | **TBD** — Build B Tier 2 second leg. Gore 4.18/1.35/9.63K9, fresh (6/10 @KC 5IP/2ER/6K); home vs MIN TBD/bullpen game (D5 → no boost). Fair-priced floor leg, not a standalone. Grade: **fair (no edge, floor leg)** | N | — | P |
| 6/15 | PIT ML (Jones, @ ATH) | ML-dog | +108 | 48% | 47.6% | +0.4 | **TBD** — Build B +200 floor-dropper. Jared Jones vs Ginn; coin-flip road dog (PIT 36-36, ATH 35-36). Used only to push the 2-leg to +222. Grade: **fair (no edge)** | N | — | P |
| 6/15 | **PHI ML −182 × TEX ML −148 (Build B Tier 2 — highest floor, RECOMMENDED 2-leg)** | +160 | 39.5% | 39.5% | **+1.0** | **TBD** — Wheeler ace anchor + Gore home fav. `parlay.py`: edge +1.0pp, EV +2.5%, **39.5% floor** → best WIN CHANCE (under +200). |
| 6/15 | **PHI ML −182 × PIT ML +108 (Build B Tier 3 — the +200 ask)** | +222 | 32.4% | 32.4% | **+1.4** | **TBD** — the genuine +200 build. `parlay.py`: edge +1.4pp, EV +4.4%, **32.4% floor** — highest-floor ticket that clears +200 (a 3-fav +200 overshoots to +386/20%). PIT coin-flip is the floor-dropper vs the +160 2-leg. |
