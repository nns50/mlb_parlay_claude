...
| 6/16 | Cease O6.5 K (TOR @ BOS) | K-Over | -130 | 61% | 53.8% | **+7.2** | **TBD** — Build B Tier 1 standalone + Tier 3 leg. Cease 2.91 ERA / 13.63 K9, last 4 starts 9/9/8/11 K, fresh (6/9 vs PHI 6IP/1ER/11K); BOS 22% K vs RHP (avg contact, home), HP Kulpa. Sharpest edge on the board. Left tail = quick hook/short start (last 4.2-7 IP). Grade: **+EV (clears gate by +5pp)** | N | — | S |
| 6/16 | SEA ML (Gilbert, vs BAL) | ML-fav | -145 | 61% | 58.2% | **+2.8** | **TBD** — Build B Tier 2/3 anchor + bankroll roll 3. Gilbert 3.62 ERA / 1.08 WHIP / 9.26 K9 ace, fresh (6/9 @BAL 6IP/1ER/5K), home vs BAL (34-39)/Brandon Young. Ace-edge +3pp. Grade: **+EV (clears gate)** | N | = 58%cl | S |
| 6/16 | ATL ML (Holmes, vs SF) | ML-fav | -161 | 63% | 60.5% | **+2.5** | **TBD** — Build B Tier 2 anchor. ATL 46-25/+107 elite vs SF 29-43/−56 (worst-ish); Holmes 4.05 ERA (short 3.2IP last start 6/9), wind blowing IN at Truist (suppresses). Good-team + bad-opponent, not purely opponent-driven. Grade: **+EV (clears gate)** | N | = 60%cl | P |
| 6/16 | TOR ML (Cease, @ BOS) | ML-fav | -112 | 56% | 51.6% | **+4.4** | **TBD** — scan value leg. Cease (2.91/13.63K9) >> BOS rookie Tolle; BOS 29-40. Market near pick'em underrates the SP gap. Grade: **+EV (clears gate)** | N | − 47%cl | P |
...
| 6/16 | PHI ML (Luzardo, vs MIA) | ML-fav | -170 | 62% | 61.5% | +0.5 | **TBD** — scan row. Luzardo 4.35 ERA / 10.07 K9 fresh (6/10 @TOR 5.2/1ER/8K); MIA hot (L10 7-3), wind 7mph Out To RF at CBP (HR-prone lefty risk). Thin, under gate. Grade: **near-fair (under gate)** | N | = 61%cl | P |
...
| 6/16 | **ATL ML −161 × SEA ML −145 (Build B Tier 2 — highest floor, RECOMMENDED 2-leg)** | +174 | 38.4% | 38.4% | **+1.9** | **TBD** — two strong favorites (ATL elite vs awful SF; Gilbert ace vs BAL). `parlay.py`: edge +1.9pp, EV +5.3%, **38.4% floor** → best WIN CHANCE (under +200). |
| 6/16 | **SEA ML −145 × Cease O6.5 K −130 (Build B Tier 3 — the +200 ask)** | +199 | 37.2% | 37.2% | **+3.8** | **TBD** — the genuine +200 build. `parlay.py`: edge +3.8pp, EV +11.2%, **37.2% floor** — clears the +3-4pp anchor bar. Cease's high-edge K-Over SUBSTITUTES for a thin coin-flip ML leg (5/27 Sanchez template), so the +200 ticket keeps ~the same floor as the all-ML Tier 2 (37.2% vs 38.4%) instead of the usual −15pp chase tax. Independent legs (different games). |

**Units-tracked tickets (flat-1u rows): 14 tickets, record 7-7, staked 14.00u, returned 21.39u → P/L +7.39u, ROI +52.8%** (added 6/10 TB+Rasmussen SGP **WON** +1.81u — a pos-corr highest-floor ticket, the diversify-era template cashing again). Real-dollar USER builds: **6/8 PHI+Sánchez SGP WON** $10→$26.70 (**+$16.70**); **6/9 MIA+ATL LOST** $30→$0 (**−$30.00**); **6/10 TB+Rasmussen SGP WON** $10→$28.10 (**+$18.10**, +181, stake confirmed); **6/11 NYM+MIA WON** $10→$32.24 (**+$22.24**, both early favs cashed). Real-$ build P/L to date = **+$27.04** (3-1). Calib leg-level: **ML-fav 12-6**, STANDALONE 0-1 vs PARLAY 17-8, recommended-not-played **39-16** (71% would-win — leaving edge on the table). **6/12 settled:** SEA W + Miller O4.5K W + MIN W + BAL W, TB L; Build B (SEA×Miller, correlated +200, RECOMMENDED) **WON** and Tier 3 (SEA×MIN) **WON**, while the all-ML Tier 2 (SEA×TB) LOST — the correlated stack again the better high-floor +200.
