...
| 6/14 | PIT ML (Skenes, vs MIA) | ML-fav | -149 | 60% | 58.7% | +1.3 | **TBD** — Build A Tier 3 leg. Skenes 2.84/0.93/10.54 K9 elite, fresh (6/9: 6IP/2ER/7K vs LAD), home; tempered by hot MIA (L10 8-2) + Meyer 2.85. Grade: **near-fair (thin, under +2pp gate)** | N | — | P |
| 6/14 | ATH ML (Springs, vs COL) | ML-fav | -185 | 62% | 63.6% | −1.6 | **TBD** — Build A Tier 2 floor leg (highest raw win prob on board). Opponent-driven: COL worst team (26-45, −104 RDiff, road). Springs shaky 4.68 (6/8: 5IP/5ER) → priced fair, no edge (D4-adjacent). Grade: **floor leg, ~0 edge (action)** | N | — | P |
...
| 6/14 | ATH ML −185 × PIT ML −149 (Build A Tier 2 — highest floor) | +157 | 37.2% | 37.2% | −1.6 | **TBD** — highest raw win chance (~37%) but **−EV** (ATH leg ~0 edge, COL-awfulness driven). Lands +157, under +200. |
| 6/14 | **NYY ML −130 × PIT ML −149 (Build A Tier 3 — the +200, RECOMMENDED)** | +196 | 35.1% | 35.1% | **+1.3** | **TBD** — disciplined 2-leg +200 (NOT a D1 chase): both legs carry edge (NYY +2.8pp, Skenes ace), true comb 35.1%, EV +3.8% (mildly +EV). ~2pp under Tier 2 floor but +EV vs Tier 2's −EV. |
