...
| 6/9 | MIA ML (Meyer, vs AZ) | ML-fav | -129 | 59% | 56.5% | +2.5 | TBD — Build A Tier 1 standalone + Tier 2/3 leg + bankroll roll 1 (attempt 3); Meyer 2.81/9.90 K9, 6-0 + AZ cold/Gallen 5.32. Grade: **+EV (clears gate)** | N | − 55%cl | S |
| 6/9 | ATL ML (Holmes, vs CWS) | ML-fav | -148 | 60% | 58.9% | +1.1 | TBD — **Build B: CWS SP Fedde→Eisert BULLPEN GAME → D5 triggered (2nd sighting, the 6/4 spot); ATL held 60% NOT boosted.** Same leg/TrueP, premise superseded. Grade: **near-fair (thin, parlay floor only)** | N | = 58%cl | P |
| 6/9 | Meyer O5.5 K (vs AZ) | K-Over | -113 | 50% | 49.5% | +0.5 | TBD — Build B: priced ~50/50; AZ C1 contact (21% K vs RHP) suppressor → DROPPED, defer to market. Grade: **no edge, correctly not bet** | N | — | S |
| 6/9 | ATL ML + MIA ML (+200 build) | Parlay (indep) | +195 | 35.4% | 33.9% | +1.5 | TBD — **PLAYED by user, $30 stake @ +195 (to win ~$58).** Build C final: disciplined 2-leg, no chase leg (D1). D5-aware (ATL floor softer). Construction note: MIA+Burns O6.5K was +7.3pp/41% floor (sharper, same payout) — lesson codified, user chose MIA+ATL. Grade: **+EV thin (action not value), high-floor +200** | Y | | P |
