...
| 6/15 | PHI ML (Wheeler, vs MIA) | ML-fav | -193 | 67.5% | 64.8% | **+2.7** | **TBD** — Build A Tier 1 standalone + bankroll roll 2. Wheeler 2.22 ERA / 0.85 WHIP / 8.42 K9, fresh (6/9 @TOR 6IP/1ER/5K) vs MIA's Gusto. Ace-edge +3pp adj. The one clean +2pp edge on the board. Grade: **+EV (clears +2pp gate)** | N | — | S |
...
| 6/15 | LAD ML (Lauer, vs TB) | ML-fav | -166 | 56% | 60.9% | **−4.9** | **TBD** — **REJECTED as anchor (D4 trap).** Lauer 5.47 ERA / 1.29 WHIP own-SP-5+ → high-variance shootout; market 60.9% discounted −5pp. Do NOT lay LAD as a clean fav tonight. Grade: **−EV anchor (D4) — correct reject** | N | — | S |
| 6/15 | HOU ML (Teng, vs DET) | ML-fav | -121 | 54% | 54.0% | +0.0 | **TBD** — scan row. HOU 33-40 home vs DET rookie Melton; pure coin-flip, no edge. Grade: **fair (no edge)** | N | — | P |
...
| 6/15 | PHI ML −193 × ARI ML −125 (Build A Tier 2 — highest floor) | +173 | 37.1% | 37.1% | +0.5 | **TBD** — Wheeler ace anchor + thin ARI fav. `parlay.py`: edge +0.5pp, EV +1.4%, 37.1% floor → best WIN CHANCE near the target (under +200). |
| 6/15 | **PHI ML −193 × ARI ML −125 × WSH ML −123 (Build A Tier 3 — the +200 ask)** | +395 | 20.4% | 20.4% | +0.2 | **TBD** — the literal "+200-and-up" build. 3 favs blow PAST +200 to +395 and the floor crashes 37%→20% (the D1 +200-chase). Logged but **recommended-against**; take the +173 2-leg or PHI standalone. |
