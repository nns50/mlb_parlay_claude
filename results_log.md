...
| 6/14 | NYY ML (Warren, @ TOR) | ML-fav | -130 | 58.5% | 55.7% | **+2.8** | **TBD** — Build A Tier 1 standalone + bankroll roll. NYY 42-27/+102 elite; Warren 3.41/9.83 K9 fresh (6/8: 4.1IP/3ER vs CLE) vs Corbin 4.55 shaky (6/8: 3IP/5ER) + sub-.500 TOR. Grade: **+EV (clears +2pp gate)** | N | — | S |
...
| 6/14 | ATH ML (Springs, vs COL) | ML-fav | -185 | 62% | 63.6% | −1.6 | **TBD** — Build A Tier 2 floor leg (highest raw win prob on board). Opponent-driven: COL worst team (26-45, −104 RDiff, road). Springs shaky 4.68 (6/8: 5IP/5ER) → priced fair, no edge (D4-adjacent). Grade: **floor leg, ~0 edge (action)** | N | − 34%cl | P |
