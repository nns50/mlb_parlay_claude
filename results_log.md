...
| 6/16 | SEA ML (Gilbert, vs BAL) | ML-fav | -145 | 61% | 58.2% | **+2.8** | **TBD** — Build B Tier 2/3 anchor + bankroll roll 3. Gilbert 3.62 ERA / 1.08 WHIP / 9.26 K9 ace, fresh (6/9 @BAL 6IP/1ER/5K), home vs BAL (34-39)/Brandon Young. Ace-edge +3pp. Grade: **+EV (clears gate)** | N | — | S |
| 6/16 | ATL ML (Holmes, vs SF) | ML-fav | -161 | 63% | 60.5% | **+2.5** | **TBD** — Build B Tier 2 anchor. ATL 46-25/+107 elite vs SF 29-43/−56 (worst-ish); Holmes 4.05 ERA (short 3.2IP last start 6/9), wind blowing IN at Truist (suppresses). Good-team + bad-opponent, not purely opponent-driven. Grade: **+EV (clears gate)** | N | — | P |
| 6/16 | TOR ML (Cease, @ BOS) | ML-fav | -112 | 56% | 51.6% | **+4.4** | **TBD** — scan value leg. Cease (2.91/13.63K9) >> BOS rookie Tolle; BOS 29-40. Market near pick'em underrates the SP gap. Grade: **+EV (clears gate)** | N | — | P |
...
| 6/16 | PHI ML (Luzardo, vs MIA) | ML-fav | -170 | 62% | 61.5% | +0.5 | **TBD** — scan row. Luzardo 4.35 ERA / 10.07 K9 fresh (6/10 @TOR 5.2/1ER/8K); MIA hot (L10 7-3), wind 7mph Out To RF at CBP (HR-prone lefty risk). Thin, under gate. Grade: **near-fair (under gate)** | N | — | P |
