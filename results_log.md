...
| 6/15 | PHI ML (Wheeler, vs MIA) | ML-fav | -193 | 67.5% | 64.8% | **+2.7** | **W (PHI 7-0 MIA)** — Build A Tier 1 standalone + bankroll roll 2 CASHED (Wheeler shut out MIA). Wheeler 2.22 ERA / 0.85 WHIP / 8.42 K9, fresh (6/9 @TOR 6IP/1ER/5K) vs MIA's Gusto. Ace-edge +3pp adj. The one clean +2pp edge on the board. Grade: **+EV (clears +2pp gate)** | N | − 63%cl | S |
| 6/15 | ARI ML (Nelson, vs LAA) | ML-fav | -125 | 55% | 54.3% | +0.7 | **W (AZ 4-3 LAA)** — Build A Tier 2 second leg. Ryne Nelson home vs LAA rookie Walbert Ureña; ARI 36-35 vs LAA 29-43. Thin (under +2pp gate) — pairs with PHI for the 2-leg, not a standalone. Grade: **near-fair (under gate)** | N | — | P |
| 6/15 | WSH ML (Alvarez, vs KC) | ML-fav | -123 | 55% | 54.6% | +0.4 | **W (WSH 7-3 KC)** — scan row (3rd leg of the +200 stretch). WSH 37-35 home vs KC 29-43; thin. Grade: **near-fair (under gate)** | N | — | P |
| 6/15 | LAD ML (Lauer, vs TB) | ML-fav | -166 | 56% | 60.9% | **−4.9** | **W-but-rejected (LAD 4-3 TB)** — D4 fade MISSED (trap fav cashed); correctly NOT bet. **REJECTED as anchor (D4 trap).** Lauer 5.47 ERA / 1.29 WHIP own-SP-5+ → high-variance shootout; market 60.9% discounted −5pp. Do NOT lay LAD as a clean fav tonight. Grade: **−EV anchor (D4) — correct reject** | N | + 63%cl | S |
| 6/15 | HOU ML (Teng, vs DET) | ML-fav | -121 | 54% | 54.0% | +0.0 | **L (DET 9-3 HOU)** — scan row. HOU 33-40 home vs DET rookie Melton; pure coin-flip, no edge. Grade: **fair (no edge)** | N | − 47%cl | P |
...
| 6/16 | ATL ML (Holmes, vs SF) | ML-fav | -161 | 62% | 60.4% | **+2.0** | **TBD** — Build A Tier 1 standalone + bankroll roll 3. ATL 46-25/+107 elite, home vs worst-record SF (29-43/−56); Holmes 4.05 (under-5 ✓). Team-quality edge +2pp. The one clean +2pp edge on the board. Grade: **+EV (clears +2pp gate)** | N | — | S |
| 6/16 | PHI ML (Luzardo, vs MIA) | ML-fav | -173 | 62% | 62.0% | +0.0 | **TBD** — Build A Tier 2 leg. Luzardo 4.35/10 K9 (clean SP, fresh 6/10) vs hot MIA; fairly priced. Floor leg, not standalone. Grade: **fair (no edge)** | N | — | P |
| 6/16 | TOR ML (Cease, vs BOS) | ML-fav | -115 | 52.5% | 52.3% | +0.2 | **TBD** — Build A Tier 3 (+200) 2nd leg. Cease 2.91/13.6 K9 elite vs Tolle (BOS) 2.70 → near coin-flip. The +200 floor-dropper. Grade: **fair (coin-flip)** | N | — | P |
| 6/16 | SEA ML (Gilbert, vs BAL) | ML-fav | -147 | 58% | 58.1% | −0.1 | **TBD** — Build A Tier 2 higher-payout alt leg. Gilbert 3.62 (clean SP) home vs BAL; fair. Grade: **fair (no edge)** | N | — | P |
...
| 6/15 | TEX ML (Gore, vs MIN) | ML-fav | -148 | 58.5% | 58.5% | +0.0 | **L (MIN 4-2 TEX)** — Build B Tier 2 second leg. MIN's bullpen game won → D5 reaffirmed. Gore 4.18/1.35/9.63K9, fresh (6/10 @KC 5IP/2ER/6K); home vs MIN TBD/bullpen game (D5 → no boost). Fair-priced floor leg, not a standalone. Grade: **fair (no edge, floor leg)** | N | — | P |
| 6/15 | PIT ML (Jones, @ ATH) | ML-dog | +108 | 48% | 47.6% | +0.4 | **L (ATH 11-2 PIT)** — Build B +200 floor-dropper busted → D1 +200-chase fade now 4-0. Jared Jones vs Ginn; coin-flip road dog (PIT 36-36, ATH 35-36). Used only to push the 2-leg to +222. Grade: **fair (no edge)** | N | — | P |
| 6/15 | **PHI ML −182 × TEX ML −148 (Build B Tier 2 — highest floor, RECOMMENDED 2-leg)** | +160 | 39.5% | 39.5% | **+1.0** | **L (PHI W, TEX L → MIN 4-2)** — Wheeler ace anchor + Gore home fav. `parlay.py`: edge +1.0pp, EV +2.5%, **39.5% floor** → best WIN CHANCE (under +200). |
| 6/15 | **PHI ML −182 × PIT ML +108 (Build B Tier 3 — the +200 ask)** | +222 | 32.4% | 32.4% | **+1.4** | **L (PHI W, PIT L → ATH 11-2)** — the +200 build busted on the PIT chase leg; standalone PHI won. Parlay tax + D1 reaffirmed. — the genuine +200 build. `parlay.py`: edge +1.4pp, EV +4.4%, **32.4% floor** — highest-floor ticket that clears +200 (a 3-fav +200 overshoots to +386/20%). PIT coin-flip is the floor-dropper vs the +160 2-leg. |
| 6/16 | **ATL ML −161 × PHI ML −173 (Build A Tier 2 — highest floor, best chance)** | +156 | 38.4% | 39.1% | **−0.7** | **TBD** — two strong home favs, clean SPs. `parlay.py`: 38.4% floor (best WIN CHANCE), EV −1.7% (parlay tax — only ATL contributes edge). Lands under +200. |
| 6/16 | **ATL ML −161 × TOR ML −115 (Build A Tier 3 — the +200 ask)** | +203 | 32.6% | 33.0% | **−0.4** | **TBD** — the genuine +200 build. `parlay.py`: 32.6% floor, EV −1.3%. Highest-floor 2-leg clearing +200 (3-fav +200 overshoots to +370/22%). TOR coin-flip is the floor-dropper (+200 tax, D1). |
