...
| 6/12 | SEA ML (B. Miller, @ WSH) | ML-fav | -140 | 57.2% | 60% | +2.8 | **TBD** — Build A Tier 1 standalone + Tier 2/3 anchor + **bankroll attempt-4 roll 2**. Miller 1.33/0.78, 9K last out (6/6) vs WSH/Littell. Grade: **+EV (clears +2pp gate)** | N | − 56%cl | S |
...
| 6/12 | **Bryce Miller Over 4.5 K** (@ WSH) | K-Over | -135 | 56.0% | 64% | **+8.0** | **TBD** — Build B Tier-1 standalone (the slate's sharpest edge, non-ML). Miller 9.67 K/9, 9 K last out 6/6; 4.5 line low; WSH neutral-K, Blaser neutral zone, no suppressor. Grade: **+EV (clears gate big)** | N | — | S |
...
| 6/12 | **SEA ML −138 × Bryce Miller O4.5 K −135 (Build B — correlated +200, RECOMMENDED)** | +200 | 38.4% | **45.5%** | **+12.1** | **TBD** — positively-correlated same-game stack (ρ≈+0.30 adds +7.1pp). Highest-floor +200 on the board (~45.5% vs ~34% all-ML); EV +36.5% at independent +200. SGP may shorten — take better of SGP vs +200. |
