...
| 6/20 | Skenes O6.5K (vs COL, Coors) — Build A Tier 1 | K-Over | +102 | 63% | 47.2% | **+15.8** | **TBD** — 9 of last 10 starts ≥7K; COL K% 21% (neutral); Coors modest suppressor. Elite arm. FanDuel. Grade: **+EV, dominant edge** | N | — | S |
| 6/20 | PIT ML (Skenes, @ COL) — Build A Tier 2 + bankroll roll 2 | ML-fav | -195 | 68% | 63.4% | **+4.6** | **TBD** — Skenes ace-edge; COL 29-47/Sugano ERA 4.54. BetUS. Grade: **+EV (clears gate)** | N | − 34%cl | S |
| 6/20 | PIT ML −195 × Skenes O6.5K +102 (Build A Tier 2 — same-game pos-corr stack) | Parlay (+corr) | +206 | 49.6% | 32.7% | **+16.9 (corr)** | **TBD** — parlay.py: true combined 49.6%, edge +16.9pp, EV +51.6%. Highest-floor +200 on board. | N | — | P |
| 6/20 | PHI ML (Sánchez, vs NYM) — Build A Tier 3 anchor | ML-fav | -175 | 65% | 61.2% | **+3.8** | **TBD** — Sánchez ERA 1.82/K9 10.55 (elite); last start 3K flag; PENDING LINEUP. FanDuel. Grade: **+EV (clears gate)** | N | — | S |
| 6/20 | Sánchez O7.5K (vs NYM) — Build A Tier 3 K-leg | K-Over | +116 | 50% | 44.0% | **+6.0** | **TBD** — PENDING LINEUP. FanDuel. Verify at 16:00. | N | — | S |
| 6/20 | PHI ML −175 × Sánchez O7.5K +116 (Build A Tier 3 alt) | Parlay (+corr) | +239 | 39.7% | 29.5% | **+10.2 (corr)** | **TBD** — true combined 39.7%, edge +10.2pp, EV +34.6%. PENDING LINEUP. | N | — | P |
| 6/20 | MIA ML (Meyer, vs SF) — scan/alt Tier 3 | ML-fav | -132 | 59% | 55.6% | **+3.4** | **TBD** — Meyer 7-0/ERA 2.75 vs SF 31-44. BetUS. Grade: **+EV** | N | — | S |
